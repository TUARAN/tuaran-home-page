...
| [ui-ux-audit-roadmap.md](ui-ux-audit-roadmap.md) | UI / 交互页面问题、证据边界、10 项改造任务与复测矩阵 | 2026-09-08 首轮记录；视觉规范沿用 docs/site-design-language.md，移动端实测待完成 |
...
- **lib/researchStyleTemplates.js**：调研写作风格的唯一正本（风格库，后台内容管理「调研风格」页签可视化）
