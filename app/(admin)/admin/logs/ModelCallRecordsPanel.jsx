...
export default function ModelCallRecordsPanel({ initialFilters = {} }) {
  ...
  const [keyFilter, setKeyFilter] = useState(initialFilters.key || '')
  const [providerFilter, setProviderFilter] = useState(initialFilters.provider || '')
  const [providerIdFilter, setProviderIdFilter] = useState(initialFilters.providerId || '')
      ...
      <Section
        ...
        actions={
          <div className="flex items-center gap-2">
            <span className="text-[12px] text-[#82847a]">共 {Number(data?.total) || 0} 条</span>
