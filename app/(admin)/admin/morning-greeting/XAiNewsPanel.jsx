  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <div>
          <label className="text-[12px] font-semibold text-[#34352f] dark:text-gray-200">可编辑发布草稿
            <textarea value={draft} onChange={(event) => setDraft(event.target.value)} rows={8} placeholder="生成结果会出现在这里；也可以直接粘贴并手动发布。" className={`${inputClass} mt-1.5`} />
          </label>
