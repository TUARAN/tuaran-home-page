          ...
          >
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[#eceee6] bg-[#fbfcf7] px-3 py-2 dark:border-[#1b2430] dark:bg-[#10161f]">
              <div className="flex items-baseline gap-2">
                ...
                <span className="font-mono text-base font-semibold text-[#15140f] dark:text-gray-100">
              ...
              {policy ? (
                ...
                >
                  {showPolicyDetails ? '收起规则说明' : '展开规则说明'}
                </button>
              ) : null}
            </div>

            {autoReconcileText ? (
              <div className="mb-4 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-950/25 dark:text-emerald-200">
                {autoReconcileText}
              </div>
            ) : null}
            ...
            {showPolicyDetails && policy ? (
              <div className="mt-5 border-t border-[#eceee6] pt-4 dark:border-[#1b2430]">
