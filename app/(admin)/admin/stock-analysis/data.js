...
export const STOCK_ANALYSIS_RECORDS = [
  ...
  {
    id: 4,
    slug: 'lobsterusdt-2026-07-13-1653',
    date: '2026-07-13',
    time: '16:53',
    pair: 'LOBSTERUSDT',
    category: { id: 'lobster', label: '龙虾币' },
    ...
    price: {
      current: 0.013577,
      // 下列开高低收来自截图中的 2026/07/13 日 K；24H 涨跌为滚动口径，二者不混算
      open: 0.014591,
      high: 0.014748,
      low: 0.013356,
      close: 0.013578,
    ...
    volume: {
      vol24hToken: 156484268,
      // 顶栏未展示 24H USDT 成交额；图中 1.013M 是当前日 K 成交额
      vol24hUsdt: null,
      vol24hDisplay: '156.48M 龙虾',
      volUsdtDisplay: '未采集',
      currentCandleVolToken: 72322000,
      currentCandleVolUsdt: 1013000,
      historicalMaxVol: '223.470M',
      totalHistoricalVol: '331.619M',
      historicalMaxVolLabel: '图示量能均线 1',
      totalHistoricalVolLabel: '图示量能均线 2',
    },
    funding: {
    ...
    keyLevels: {
      ...
      support1: 0.013356,
      support2: 0.011939,
      historicalHigh: 0.020803,
      recentLow: 0.005208,
      reboundFromLowPct: 161,
    },
    riskSignals: {
      highFundingRate: true,
      volumePriceDivergence: true,
    ...
    analysisSummary: {
      ...
      sentiment: '偏多但杠杆拥挤',
      keyConcern:
        '价格仍站在 MA25/MA99 上方，中期结构未坏，但当日回落至 MA7 下方且量能低于图示量能均线；4 小时资金费率 0.06463%、简单年化约 141.5%，多头拥挤是当前主要风险。0.013356 为短线防守位，跌破后需警惕向 MA25（0.011939）回撤',
      action: '等待 0.013356 支撑确认，跌破则观望',
    },
    dataSource: 'Binance 永续合约日线行情截图（2026-07-13 16:53）',
  },
]
