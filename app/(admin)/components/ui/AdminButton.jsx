...
export default function AdminButton({
  ...
  const cls = `admin-button inline-flex items-center justify-center gap-1.5 rounded-lg font-medium whitespace-nowrap transition disabled:opacity-50 ${sizeCls} ${
