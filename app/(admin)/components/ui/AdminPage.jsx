 ...
 */
export default function AdminPage({ title, description, actions, children, maxWidth = '1100px', compact = false }) {
  return (
    <main className={`mx-auto w-full px-4 md:px-6 ${compact ? 'py-5 md:py-5' : 'py-7 md:py-9'}`} style={{ maxWidth }}>
      {!compact ? (
