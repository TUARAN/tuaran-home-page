      ...
      <div className="flex min-w-0 flex-nowrap items-baseline gap-3 overflow-hidden">
        ...
        <div className="flex min-w-0 items-baseline gap-1">
          ...
          <button
            ...
            title="换一句名言"
            className="inline-flex shrink-0 align-[-0.15em] text-[#85877d] transition-colors hover:text-[#4f5149] focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a4a88e] disabled:cursor-wait dark:text-[#737f91] dark:hover:text-gray-300"
          >
            <IconRefresh
              size={13}
              stroke={1.8}
