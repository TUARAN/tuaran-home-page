...
export default function ArticleFooterCta() {
  return (
    <aside className="mx-auto mt-12 max-w-[72ch] border-t border-[#e8dfd0] pt-8 dark:border-gray-800">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        ...
        >
          <span className="text-[18px]" aria-hidden="true">💬</span>
          <div className="flex-1">
            <div className="text-[15px] font-semibold text-[#221f19] dark:text-gray-100">加入社群 →</div>
            <p className="mt-0.5 text-[12px] leading-5 text-[#666] dark:text-gray-400">
              微信小红书读者群，不焦虑，慢节奏
            </p>
          </div>
        ...
        >
          <span className="text-[18px]" aria-hidden="true">📚</span>
          <div className="flex-1">
            <div className="text-[15px] font-semibold text-[#221f19] dark:text-gray-100">知识库 →</div>
            <p className="mt-0.5 text-[12px] leading-5 text-[#666] dark:text-gray-400">
              精选文章 + 公司调研 + 事项调研 + 人物调研
            </p>
          </div>
      ...
      <p className="mt-6 text-center text-[12px] text-[#999] dark:text-gray-500">
        合作 / 咨询 / 调研定制见 <Link href="/services" className="text-[#7f6f55] no-underline hover:text-[#221f19] dark:text-[#c8b99d] dark:hover:text-gray-100">合作说明</Link> · 微信 <span className="font-mono">atar24</span>
      </p>
    </aside>
  )
}
