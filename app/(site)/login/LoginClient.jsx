  ...
  return (
    <main className="mx-auto w-full max-w-xl px-4 py-12 sm:py-20">
      <section className="rounded-3xl border border-[#e5dccd] bg-[#fdfaf3] p-6 shadow-[0_20px_60px_rgba(82,69,45,0.08)] dark:border-[#293241] dark:bg-[#111821] sm:p-8">
        ...
        <h1 className="mb-8 text-2xl font-semibold text-[#211d17] dark:text-gray-100">登录</h1>
        ...
        <div className="my-6 flex items-center gap-3 text-xs text-[#9b907f] dark:text-[#738095]">
          <span className="h-px flex-1 bg-[#e3dacb] dark:bg-[#2d3746]" />
          <span>或</span>
          <span className="h-px flex-1 bg-[#e3dacb] dark:bg-[#2d3746]" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <a
            ...
            className="rounded-xl border border-[#ddd2c0] px-4 py-2.5 text-center text-sm font-medium text-[#3f392f] no-underline transition hover:bg-[#f4ede0] dark:border-[#344052] dark:text-gray-200 dark:hover:bg-[#19212b]"
          >
            GitHub 登录
          </a>
          <a
