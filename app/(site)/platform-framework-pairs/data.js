...
export const PAIRS = [
  ...
  },
  {
    ...
    backlash: 20,
    aiIntegration: 75,
    primaryLockIn: 'Workers AI / Agents SDK / Pages Functions / Vite plugin 默认整合',
    latestSignal: '2024-09 VoidZero 成立；CF × Vue 实质性整合传闻待官方确认',
    developerNote: 'Vite 中立性是核心问题；如果 CF 实质控股，前端工具链整体受影响',
    competitorNote: 'Vercel 锁定 React 一侧，CF 走 Vue 路径建立对称力量',
