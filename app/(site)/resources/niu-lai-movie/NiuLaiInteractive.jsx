...
const reviewSteps = [
  ...
  },
  {
    ...
    eyebrow: '内容门槛',
    title: '审查影片是否触碰内容红线',
    text: '《电影产业促进法》规定，完成片由国务院电影主管部门或省级电影主管部门审查，并组织不少于五名专家评审。影片制作粗糙本身不等同于触碰法定内容红线。',
  },
  {
    id: 'technical',
    label: '技术审查',
    eyebrow: '放映门槛',
    title: '核验最终发行版与数字母版',
    text: '送审须知和数字母版规范覆盖载体、DCP结构、画面、声音、字幕、加密与文件完整性等项目。它们解决的是母版能否按规范交付和放映，不为建模精度、动作美感或商业价值评分。',
  },
  {
    id: 'license',
    label: '公映许可',
    eyebrow: '2024',
    title: '取得龙标后进入院线发行',
    text: '国家电影局公示确认《牛来》的公映许可证为电审动字〔2024〕第33号，第一出品单位为大连璟园文化影视传媒有限公司。许可证证明影片具备公映资格，不等于主管部门为艺术水准或商业价值背书。',
  },
]
...
const questions = [
  {
    title: '背后到底是谁在审批？',
    answer: '法律规定，完成片由国务院电影主管部门或省级电影主管部门审查，并组织不少于五名专家评审。国家电影局公开了《牛来》的备案与公映许可结果，但许可证名单不披露每名评审人员，现有证据也没有显示影片经过特殊通道。',
  },
  {
