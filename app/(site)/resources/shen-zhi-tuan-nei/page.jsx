  ...
  return (
    <PageContainer width="narrow" className="py-12">
      ...
      <article className="prose prose-sm max-w-none dark:prose-invert prose-headings:font-serif prose-headings:font-semibold prose-h2:text-xl prose-h3:text-base prose-p:leading-relaxed prose-p:text-[#333] dark:prose-p:text-gray-300 prose-hr:border-[#eee] dark:prose-hr:border-gray-800">
        ...
        <p>我们不想对所谓"从上到下"过多评价，但我有一个关键发现：在一个联盟结构中向管理层和公司运作整个流程，每个工号都被赋予了一个"权重"，而这是一套中等逻辑的结构，只是在跨层级时才能达到真正的目的。</p>
        ...
        <p>从我的观察来看，最近很多情况是：那种反人类的产品路径，通过内部流程进行层层补充，形成了一整套逻辑自洽的"成功路径"，而路径依赖真的是一套套向下传递的。</p>

        <h3>二、所谓"数据是组织生命线"，把控着整条分发链</h3>
        ...
        <p>AI 包括在 Coupons、美团等各百亿级别的平台上，目前的落地方式仅仅是提升 LTV 的数量，然后整体把控 AI 层面，做了一个"更好看"的架构——仅仅是框架，没有能真正到达用户的能力。</p>
        ...
        <p>与此同时，内容和媒体运营在整套美团内部一直是一套"二等"关系——从来不参与真正的交叉业务决策，始终是独立个体，交叉之后也往往难以产生真实结果。</p>
        ...
        <p>管理层的所谓"决心"，总是在流程层面呈现，而非真正落到资源的分配上来。</p>
