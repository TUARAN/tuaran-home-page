...
Project matrix: TUARAN 主编札记, 矩联科技, 博主联盟, 前端周看, Open Claude Code, SyncBlog, Web LLM experiments, context memory, and Skill Center.
...
涂阿燃（Tuaran，也使用"掘金安东尼""安东尼404"等社区身份）是一名程序员、项目经理、技术博主、出版作者，也是矩联科技创始人。他从前端工程化、技术写作和项目交付一路延伸到 AI Agent、内容自动化和个人数字系统建设，公开内容累计 500+ 篇、阅读 400 万+。他的工作重心不是单点工具，而是把复杂问题拆成流程、标准、站点、数据和自动化，让个人经验变成可复用系统。当前重点项目包括 TUARAN 主编札记、矩联科技、博主联盟、前端周看、Open Claude Code、AI分发大师，以及围绕 Web LLM、上下文记忆、Skill 中心等方向的实验项目。
