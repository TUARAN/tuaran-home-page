...
export default function SyncblogPublisherPage() {
  return (
    <main className="mx-auto min-h-screen w-full max-w-4xl px-4 py-10 text-slate-900 dark:text-slate-100">
      <div className="text-xs text-slate-500"><Link href="/tools" className="hover:underline">工具库</Link>　/　<Link href="/downloads#extensions" className="hover:underline">浏览器扩展</Link></div>
