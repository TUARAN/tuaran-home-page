...
export default function DesktopPetPage() {
  return (
    <main className="min-h-screen bg-[var(--page-bg)] px-5 py-16 text-[#263f39] dark:text-[#f7edd8]">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-12 rounded-2xl bg-[var(--site-panel)] p-6 leading-8 dark:bg-[#213b35]">
