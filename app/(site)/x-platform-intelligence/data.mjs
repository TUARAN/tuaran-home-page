...
const sourceDimensionCoverage = {
  ...
  'x-spaces': ['realtime', 'content-longevity', 'public-conversation', 'native-monetization'],
...
const fixedCoverageGaps = [
  ...
  { id: 'gap-source-x-country-share-unavailable', gapKind: 'metric', platformId: 'x', metricId: 'country-share', reason: 'The verified DataReportal source lists country-level X advertising reach counts but does not directly publish each country’s share of the global X audience.', attemptedSourceUrl: 'https://datareportal.com/essential-x-stats', checkedAt: ACCESSED_AT, impact: 'Country-share remains unavailable; absolute country reach is not divided by the rounded global ad-reach total. Use the separately sourced internet-penetration view instead.' },
