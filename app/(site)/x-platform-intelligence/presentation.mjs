...
const SEGMENT_LABELS = {
  ...
  'community-urban': '城市社区成年人',
  'community-suburban': '郊区社区成年人',
  'community-rural': '乡村社区成年人',
  'rep-lean-rep': '共和党 / 倾共和党成年人',
  'dem-lean-dem': '民主党 / 倾民主党成年人',
  'major-or-minor-reason': '主要或次要使用理由',
  'reason-entertainment': '娱乐',
  'reason-news': '获取新闻',
  'reason-shared-interests': '连接共同兴趣者',
  'reason-sports-pop-culture': '体育或流行文化',
  'reason-politics': '政治或政治议题',
  'reason-friends-family': '亲友动态',
  'reason-product-reviews': '产品评论或推荐',
  'news-users': '新闻用户',
