...
export const articles = [
  ...
  },
  {
    ...
    content: [
      ...
      '起初听到权游“混乱是阶梯”的时候，总会下意识把它和野心、算计、翻盘联系在一起。可现在再回头看，我认为它更像是在描述一种世界运行的方式。很多重要的变化，并不是计划好的，而是在一片杂乱之中慢慢长出来的。',
      '生活是这样，时代也是。',
      '世界之所以还有意思，是因为它并不能被完全算清。事情总会在某个节点偏离预期，走向一个谁都没有真正准备好的方向。正是这些偏差，让未来变得真实。',
      '想到这里，我突然联想起数学里的那个老问题，P 和 NP。我们好像本能地相信它们不相等，也并不急着看到最终答案。因为一旦所有问题都能被迅速算出来，很多努力都会显得多余。选择、试错、犹豫、后悔，都会失去存在的意义。',
