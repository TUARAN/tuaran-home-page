      ...
      <head suppressHydrationWarning>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var root=document.documentElement;var ui=localStorage.getItem('site-ui-mode');root.dataset.ui=ui==='classic'?'classic':'polished';var v=localStorage.getItem('reading-bg');if(v){root.style.setProperty('--page-bg',v);}}catch(e){}})();`,
          }}
        />
      </head>
