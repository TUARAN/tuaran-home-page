    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <header className="mb-10 border-b border-[#eee] dark:border-gray-800 pb-2">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <h1 className="font-serif text-2xl md:text-3xl font-semibold tracking-wide text-[#222] dark:text-gray-100">人工智能先驱</h1>
            <p className="text-sm text-[#666] dark:text-gray-300 mt-2">人物调研：以时间线梳理深度学习先驱群像与关键贡献。</p>
