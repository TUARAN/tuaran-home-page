    ...
    <div className="mx-auto w-full max-w-[1120px] px-4 py-8">
      <section className="rounded-[24px] border border-[#e8e2d6] bg-[#fcfbf7] p-5 shadow-[0_12px_40px_rgba(82,69,45,0.06)] dark:border-[#252d36] dark:bg-[#0f141b] md:p-6">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="no-external-arrow block overflow-hidden rounded-2xl border border-[#e6dfd2] bg-white shadow-[0_16px_40px_rgba(82,69,45,0.08)] transition hover:shadow-[0_22px_52px_rgba(82,69,45,0.13)] dark:border-[#2a3440] dark:bg-[#0f141b]"
        >
          <Image
