    ...
    sections: [
      {
        title: '感悟',
        paragraphs: [
          '当前的软件架构正在发生一次分层重排。过去的软件体系中，用户通过 App 操作系统，软件内部由代码承担业务逻辑与流程控制；而在 AI 时代，大模型开始承担通用逻辑层的角色，负责理解、判断与推理，智能体则像新的软件形态，负责组织任务、调用工具与执行流程。',
          '系统的核心从"写死的程序逻辑"转向"可推理的能力调度"，软件不再完全由代码定义，而由模型驱动行为生成。',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: '感悟',
        paragraphs: [
          '无论是大模型，还是机器人技术，它们正在重新定义工作方式，也在悄然改变个人发展的路径。',
          '选择主动学习和参与这些变化，是希望为自己打开新的空间，让能力结构能够跟上时代的节奏。在技术快速演进的阶段，保持开放与行动，本身就是一种面向未来的准备。',
          '从更大的视角看，人类社会的每一次跃迁，都源于对新工具和新能力的探索与实践。那些推动时代向前的人，往往只是更早一步理解变化，并愿意走进变化之中。',
        ],
      },
    ],
  },
