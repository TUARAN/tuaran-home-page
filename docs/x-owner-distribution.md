...
- 触发：每天 5 条，08:00 早安、09:30 认识新朋友、12:00 午安、15:00 蓝 V 交流、19:00 互关串门。各时段前后 30 分钟浮动，每 5 分钟检查到期任务。加密、文化故事、美区英文与晚安已暂停，手动请求也跳过；历史数据保留。图文使用原创猫咪表情包，详见 `ai-context/x-post-images.md`。
