  ...
  return [
    {
      ...
      content:
        ...
        '包括主营业务与行业地位、最近财报与业绩预告、近期重大公告与新闻、管理层与治理、机构研报观点等。' +
        '每条关键事实必须能追溯到用户提供的资料或你实际检索到的来源；检索不到、无法核实的，' +
        '一律留在「九、未能验证」小节并说明查证路径。不得编造财务数字、并购重组、管理层变动、' +
        '业绩预期等信息，也不得编造来源 URL。全程最多执行 3 次联网检索，优先覆盖主营业务与最新业绩；' +
    ...
    },
    {
      ...
      content: [
        ...
        '写作约束：',
        [
          '联网检索：你有 web_search 工具可用，每次检索前先想清楚要核实的点（如主营构成、最新年报/预告关键数字、近期公告/新闻、实控人与股权结构），优先检索 2–3 个最关键的信息点。',
          ...
          '「十、信息来源与说明」写：巨潮资讯公司列表、腾讯行情接口、本次检索实际使用的来源（名称 + URL），资料截至今天；自动生成稿待人工复核。',
