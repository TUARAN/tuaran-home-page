...
export const QUOTE_BATCH_SIZE = 60
export const QUOTE_CONCURRENCY = 8
export const DEFAULT_STALE_DAYS = 7
export const MAX_DRAFT_ATTEMPTS = 5
export const GENERATION_TIMEOUT_MS = 22_000
  ...
  return [
    {
      role: 'system',
      content:
        '你是 A 股上市公司观察研究助手。你只能使用用户消息里提供的资料（公司身份、板块、实时行情）写作；' +
        '没有公开证据的财务数字、管理层变动、并购重组等信息一律不要编造，留在「九、未能验证」小节并说明查证路径。' +
        '输出完整 Markdown 文章，包含 frontmatter 与十个小节；不要输出代码围栏，不要输出任何额外说明。',
    },
    {
      role: 'user',
      content: [
        ...
        [
          ...
          '「十、信息来源与说明」写：巨潮资讯公司列表、腾讯行情接口，资料截至今天；自动生成稿待人工复核。',
