  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/planning', '/admin/portfolio', '/admin/ai-workspace', '/admin/model-dispatch', '/admin/deepseek-tasks', '/admin/ops', '/admin/site-dev', '/admin/cloudflare-personal-site-map', '/admin/context-memory'],
      },
    ],
  },
  {
