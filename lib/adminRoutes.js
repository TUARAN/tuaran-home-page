  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/db', '/admin/site-status', '/admin/settings', '/admin/seo', '/admin/security-self-check', '/admin/short-links', '/admin/archives', '/admin/reverse-lab', '/admin/blogger-eye'],
        sections: [
          {
            id: 'runtime',
            label: '运行与配置',
