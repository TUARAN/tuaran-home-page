  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/long-compass', '/admin/flower-diary', '/admin/self-regulation', '/admin/person-strawberry', '/admin/share', '/admin/information', '/admin/nsfw'],
        sections: [
          {
            id: 'vaults',
            label: '个人密文',
            items: [
              ...
              { href: '/admin/flower-diary', label: '采花日记', icon: 'flower' },
