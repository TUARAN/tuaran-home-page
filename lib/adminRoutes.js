  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        shortLabel: '索引',
        icon: 'articles',
        desc: 'D1 内容索引：同步构建期注册表 + 手工登记（发布不依赖构建）',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        shortLabel: '开发',
        icon: 'siteDev',
        desc: 'GitHub / npm 进度同步、Issue 待办与发布状态',
      },
      {
        href: '/admin/cloudflare-personal-site-map',
        label: 'Cloudflare 技术地图',
        shortLabel: 'CF 地图',
        icon: 'database',
        desc: '本站 Cloudflare 架构、public/admin/API 边界与扩展技术细节',
      },
      {
    ...
    items: [
      {
        ...
        shortLabel: '舆情',
        icon: 'publicOpinion',
        // 主站页面，不在 admin 子域 allow-prefix 内：在 admin.2aran.com 上直接跳 canonical host（见 AdminSidebar）
        external: true,
