    ...
    items: [
      {
        ...
        activePaths: ['/admin/articles', '/admin/content-index', '/admin/recommendations', '/admin/quotes', '/admin/research-style', '/admin/content-taxonomy', '/admin/content-weekly', '/admin/rss-feeds', '/admin/engagement-bots', '/admin/wallpapers'],
        sections: [
          {
            id: 'library',
            label: '内容资产',
          ...
          },
          {
            ...
            items: [
              ...
              { href: '/admin/quotes', label: '名言管理', icon: 'researchStyle' },
            ],
          },
          {
            id: 'governance',
      ...
      },
      {
        ...
        activePaths: ['/admin/ai-workspace', '/admin/ops', '/admin/a-share-research', '/admin/morning-greeting', '/admin/deepseek-tasks'],
        sections: [
          {
            id: 'control',
            label: '执行与审计',
      ...
      },
      {
        ...
        activePaths: ['/admin/planning', '/admin/portfolio', '/admin/model-dispatch', '/admin/site-dev', '/admin/integrations', '/admin/cloudflare-personal-site-map', '/admin/context-memory'],
        sections: [
          {
            id: 'governance',
            label: '项目治理',
            items: [
              ...
              { href: '/admin/model-dispatch', label: 'AI 规划与分派', icon: 'modelDispatch' },
            ],
          },
          {
            id: 'engineering',
            label: '站点工程',
            items: [
              { href: '/admin/site-dev', label: '开发与发布', icon: 'siteDev' },
              { href: '/admin/integrations', label: '集成与 API Keys', icon: 'integrations' },
          ...
          },
          {
            id: 'context',
            label: '工程上下文',
            items: [{ href: '/admin/context-memory', label: '上下文记忆', icon: 'memory' }],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        shortLabel: '私密',
        icon: 'compass',
        desc: '个人密文、密码保护分享与私有媒体资产',
        activePaths: ['/admin/long-compass', '/admin/soft-sticker', '/admin/self-regulation', '/admin/person-strawberry', '/admin/share', '/admin/information', '/admin/nsfw'],
        sections: [
          {
            id: 'vaults',
            label: '个人密文',
            items: [
              ...
              { href: '/admin/soft-sticker', label: 'SoftSticker', icon: 'flower' },
              { href: '/admin/self-regulation', label: '锻炼与自控', icon: 'wellbeing' },
              { href: '/admin/person-strawberry', label: '草莓专题', icon: 'personProfile' },
              { href: '/admin/information', label: '信息保险库', icon: 'information' },
            ],
          },
          {
            id: 'distribution',
            label: '加密分发',
            items: [{ href: '/admin/share', label: '密码保护分享', icon: 'share' }],
          },
          {
            id: 'assets',
            label: '私有资产',
            items: [{ href: '/admin/nsfw', label: '私有媒体库', icon: 'nsfw' }],
          },
        ],
      },
    ],
