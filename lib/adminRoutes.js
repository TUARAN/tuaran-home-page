    ...
    items: [
      {
        ...
        activePaths: ['/admin/articles', '/admin/content-index', '/admin/recommendations', '/admin/quotes', '/admin/research-style', '/admin/content-taxonomy', '/admin/content-weekly', '/admin/rss-feeds'],
      },
      {
        href: '/admin/projects',
        label: '项目与工程',
        ...
        activePaths: ['/admin/planning', '/admin/portfolio', '/admin/ai-workspace', '/admin/model-dispatch', '/admin/deepseek-tasks', '/admin/a-share-research', '/admin/ops', '/admin/site-dev', '/admin/cloudflare-personal-site-map', '/admin/context-memory'],
      },
      {
        href: '/admin/a-share-research',
        label: 'A 股研究自动化',
        shortLabel: 'A 股研究',
        icon: 'aShareResearch',
        desc: '线上每日选题、DeepSeek 草稿与运行日志',
      },
    ],
  },
  {
