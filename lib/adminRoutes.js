    ...
    items: [
      {
        ...
        activePaths: ['/admin/articles', '/admin/articles/research-import', '/admin/content-index', '/admin/recommendations', '/admin/research-style', '/admin/content-taxonomy', '/admin/content-weekly', '/admin/rss-feeds', '/admin/wallpapers'],
        sections: [
          {
            id: 'library',
            label: '内容资产',
          ...
          },
          {
            ...
            label: '反馈与分发',
            items: [
              { href: '/admin/content-weekly', label: '数据统计', icon: 'analytics' },
      ...
      },
      {
        ...
        activePaths: ['/admin/personal-profile', '/admin/soft-sticker', '/admin/self-regulation', '/admin/person-strawberry', '/admin/share', '/admin/information', '/admin/nsfw', '/admin/stock-analysis'],
        sections: [
          {
            id: 'vaults',
            label: '个人密文',
