    ...
    items: [
      {
        ...
        hubDescription: '从创作、入库到发布后的反馈，按同一条内容生命周期组织。',
        eyebrow: '内容生命周期',
        flow: ['内容管理', '数据统计', '持续校正'],
        activePaths: ['/admin/articles', '/admin/articles/research-import', '/admin/recommendations', '/admin/research-style', '/admin/content-taxonomy', '/admin/content-weekly', '/admin/rss-feeds', '/admin/wallpapers'],
        sections: [
          {
            id: 'publish',
            label: '创作与发布',
            desc: '在同一工作台完成创作、发布与全站内容状态管理。',
            items: [
              { href: '/admin/articles', label: '内容管理', icon: 'articles', desc: '统一查看三种文章来源：仓库历史文章、D1 后台文章和 research 调研文章，并按各自流程编辑或审批。', note: '来源说明 + 列表 + 审批' },
          ...
          },
          {
            id: 'ops',
            label: '规范与运营',
            desc: '发布前校正表达，发布后根据真实阅读与订阅行为继续调整。',
            items: [
      ...
      },
      {
        ...
        shortLabel: '自动化',
        icon: 'ops',
        desc: '自动任务、内容流水线、模型服务与运行记录',
        hubDescription: '统一查看自动任务、内容流水线、模型服务和执行记录。',
        eyebrow: '从任务到复盘',
        flow: ['登记任务', '自动执行', '核对日志', '结果复盘'],
        activePaths: ['/admin/ai-workspace', '/admin/ops', '/admin/a-share-research', '/admin/crypto-research', '/admin/morning-greeting', '/admin/article-distribution', '/admin/quotes', '/admin/engagement-bots', '/admin/deepseek-tasks', '/admin/logs'],
        sections: [
          {
            id: 'control',
            label: '登记与记录',
            desc: '先维护自动化和模型服务清单，再在日志里核对运行与调用。',
            items: [
              { href: '/admin/ops', label: '自动化台账', icon: 'ops', desc: '统一登记云端与本地自动化，查看调度状态、风险与审核要求。' },
              { href: '/admin/deepseek-tasks', label: '模型服务', icon: 'deepseekTasks', desc: '管理 DeepSeek 密钥与 NAS Ollama 服务，查看模型列表与连通状态。' },
              { href: '/admin/logs', label: '日志记录', icon: 'logs', desc: '查看自动化最近运行和模型调用记录，核对耗时、失败原因与 Token。' },
            ],
          },
          {
            id: 'pipelines',
            label: '内容流水线',
            desc: '管理有明确输入、审核窗口和发布结果的自动内容任务。',
            items: [
              ...
              { href: '/admin/article-distribution', label: '文章一键分发', icon: 'share', desc: '选择站内文章，通过浏览器插件写入六个平台草稿。' },
              { href: '/admin/quotes', label: '名言生成', icon: 'researchStyle', desc: '每天自动生成原创短句并留档，前台从名言池随机展示。', note: '每日自动生成' },
      ...
      },
      {
        ...
        activePaths: ['/admin/planning', '/admin/portfolio', '/admin/site-dev', '/admin/subsites', '/admin/integrations', '/admin/cloudflare-personal-site-map', '/admin/context-memory'],
        sections: [
          {
            id: 'governance',
            label: '项目治理',
            items: [
              { href: '/admin/planning', label: '规划与待办', icon: 'planning' },
          ...
          },
          {
            ...
            items: [
              ...
              { href: '/admin/subsites', label: '二级站点', icon: 'portfolio' },
      ...
      },
      {
        ...
        activePaths: ['/admin/db', '/admin/site-status', '/admin/settings', '/admin/seo', '/admin/design', '/admin/security-self-check', '/admin/short-links', '/admin/archives', '/admin/reverse-lab', '/admin/blogger-eye'],
        sections: [
          {
            id: 'runtime',
            label: '运行与配置',
            items: [
              ...
              { href: '/admin/site-status', label: '故障公告', icon: 'ops' },
          ...
          },
          {
            ...
            items: [
              ...
              { href: '/admin/design', label: '设计与体验', icon: 'researchStyle' },
              { href: '/admin/security-self-check', label: '涉密自检', icon: 'audit' },
          ...
          },
          {
            ...
            label: '系统实验',
            items: [
              { href: '/admin/reverse-lab', label: '逆向测试', icon: 'reverseLab' },
              { href: '/admin/blogger-eye', label: '小眼睛', icon: 'eye' },
            ],
          },
        ],
      },
