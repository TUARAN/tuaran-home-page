  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/personal-profile', '/admin/soft-sticker', '/admin/self-regulation', '/admin/person-strawberry', '/admin/share', '/admin/information', '/admin/nsfw', '/admin/bookmark-nav', '/admin/stock-analysis'],
        sections: [
          {
            id: 'vaults',
            label: '个人密文',
