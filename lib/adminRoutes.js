    ...
    items: [
      {
        ...
        activePaths: ['/admin/articles', '/admin/content-index', '/admin/research-style', '/admin/content-weekly', '/admin/rss-feeds'],
      },
      {
        href: '/admin/projects',
        label: '项目与工程',
      ...
      },
      {
        ...
        shortLabel: 'AI 协同',
        icon: 'modelDispatch',
        desc: '任务规划、Agent 分派与 LLM 调用审计',
        activePaths: ['/admin/model-dispatch', '/admin/deepseek-tasks'],
      },
      {
        href: '/stock-analysis',
        label: '交易分析',
    ...
    items: [
      {
        ...
        shortLabel: '运维',
        icon: 'ops',
        desc: 'D1 数据健康与自动化运行状态',
        activePaths: ['/admin/db', '/admin/ops'],
      },
      {
        href: '/admin/settings',
        label: '站点配置',
