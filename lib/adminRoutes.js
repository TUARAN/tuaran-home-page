  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/ai-workspace', '/admin/ops', '/admin/a-share-research', '/admin/morning-greeting', '/admin/article-distribution', '/admin/quotes', '/admin/engagement-bots', '/admin/deepseek-tasks'],
        sections: [
          {
            id: 'control',
            label: '执行与审计',
        ...
        sections: [
          {
            ...
            items: [
              ...
              { href: '/admin/model-dispatch', label: '规划分派', icon: 'modelDispatch' },
            ],
          },
          {
            id: 'engineering',
