  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        activePaths: ['/admin/planning', '/admin/portfolio', '/admin/ai-workspace', '/admin/model-dispatch', '/admin/deepseek-tasks', '/admin/a-share-research', '/admin/ops', '/admin/site-dev', '/admin/integrations', '/admin/cloudflare-personal-site-map', '/admin/context-memory'],
      },
      {
