export const CHANGELOG = [
  {
    ...
    summary:
      '7 月 27 日至 31 日共完成 99 次非合并提交，其中约 47 次来自前端周刊与内容同步。人工改动集中在账号与帮助文档、文章互动、内容发现、行为数据和分类治理：统一目录按用途进入，再按内容形态、主题、研究对象和使用方式筛选；首页、导航、搜索和内容阅读开始记录可用于判断新访客是否找到起点的匿名事件。',
    planned: [
