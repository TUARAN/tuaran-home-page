export const CHANGELOG = [
  {
    ...
    range: '2026-07-27',
    commits: 13,
    title: '账号、文档、互动通知与首页阅读体验集中收口',
    summary:
      '本周先处理长期积累的体验分叉：账号菜单与个人资料回到统一尺寸和信息层级，帮助中心改为站内文档，文章详情页统一元信息与阅读统计；同时补齐互动通知和周总结任务，并继续提高首页首屏与长屏的内容密度。',
    planned: [
      '在线上环境回归账号语言切换、通知跳转、周总结任务和首页推荐轮换。',
      '继续梳理今天改造后不再使用的旧组件与兼容样式，减少同一功能多套实现。',
    ],
    done: [
      '重做账号下拉菜单与个人资料页，集中展示燃币、已解锁资源和账号信息，并清理游客身份等旧界面噪音。',
      '把帮助中心改为文档优先的站内阅读结构，补齐缺失说明，减少无意义的跨页跳转。',
      '修复中英文切换交互，让语言选项能够实际更新全站状态。',
      '统一精选文章与其他文章详情页的元信息、阅读量和互动样式。',
      '为非站长用户的点赞、评论与回复补齐小铃铛通知，并加入每周一执行的周总结 GitHub Actions。',
      '压缩首页文章条目与顶部留白，并把桌面推荐数量提高到 14–18 条，移动端维持 10 条。',
    ],
  },
  {
    version: '2026-W30',
