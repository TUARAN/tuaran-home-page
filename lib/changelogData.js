export const CHANGELOG = [
  {
    ...
    range: '2026-07-27',
    commits: 25,
    title: '账号、内容体验、数据能力与全站自我指涉治理',
    summary:
      '7 月 27 日完成 25 次 Git 提交，其中 9 次为前端周刊自动同步；其余更新集中在账号与帮助文档、文章互动与首页体验、更新日志、内容 PV 和全站自我指涉治理。内容库先清理模板化假对比和空转导航，公开功能、站点说明、燃币与内容分类同步改为读者视角。',
    planned: [
