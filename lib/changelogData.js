export const CHANGELOG = [
  {
    version: '2026-W36',
    week: '2026-W36',
    range: '2026-08-28 至 2026-09-02',
    commits: 85,
    lastCommit: 'f8fdbffccab523e0110f2f6d314e5b80fdc3cd18',
    title: '跨站账号、WorkBuddy 通信与运维可靠性集中推进',
    summary:
      '这一轮把二级站点、个人工具和后台运维继续接入统一体系：主站账号与签到扩展到子站，WorkBuddy 增加课程、皮肤、短信智能体等能力；Blogger Eye 迁往云端并进入后台，D1、诗词发布和站点异常通知得到加固，作品、工具与关于页的信息架构也完成新一轮收束。',
    planned: [
      '在线上回归跨站登录、签到、WorkBuddy 课程解锁与短信收发，重点核对身份映射、支付状态和失败重试。',
      '继续观察 Blogger Eye 云端巡检、站点异常通知、D1 用量保护和诗词发布链路，降低误报、漏报与免费额度超限风险。',
      '验证作品、工具和关于页重构后的旧链接兼容、移动端导航与搜索收录，及时修复失效入口。',
      '梳理统一分析、VibeCafé 遥测与个人成长档案的数据口径，明确公开展示和私密留存边界。',
    ],
    done: [
      ...
      '新增智能体记忆、WorkBuddy 短信集成、OpenClaw 更新、幼儿照护偏好、Robinhood Chain 等调研，继续自动发布 A 股与加密货币观察。',
    ],
  },
  {
    version: '2026-W35',
