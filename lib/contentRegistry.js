...
export const CONTENT_PV_ENTRIES = [
  ...
  { category: 'resource', slug: 'cnt-whitepaper', title: 'CNT内容生态代币经济白皮书（正式完整版）', href: '/onchain-blog/whitepaper', date: '2026-09-21', summary: 'CNT 内容生态代币经济白皮书：总量封顶、双因子衰减挖矿、质量加权贡献分、四层反女巫、销毁分红与 DAO 治理，附智能合约模块清单。', tags: ['CNT', 'Content Token', '白皮书', '内容上链', '代币经济', 'DAO'] },
