/**
 * 自建阅读统计：非调研内容的可追踪清单（资源主题页 + 互动专题 + 灵感流）。
 *
 ...
 *   - 'feed'    ：灵感流
 *   - 'article' ：精选文章
 *   - 'rich-page'：互动专题（内部 category 保留旧值，避免破坏历史统计）
...
import { getAllFeedItems } from '../app/(site)/feed/data'
import { ENGINEERING_WORKS, getRichPagePvKey } from './engineeringWorks'
...
export const CONTENT_PV_ENTRIES = [
  ...
  { category: 'resource', slug: 'cz-memoirs', title: '赵长鹏自传《币安人生》在线阅读｜CZ 回忆录简体中文版', href: '/resources/cz-memoirs', date: '2026-09-15', summary: '赵长鹏（CZ）自传《币安人生》简体中文全文：从江苏农村、加拿大求学到创立币安，以及监管风暴、入狱与特赦。', tags: ['赵长鹏', '币安人生', 'CZ', '回忆录', '币安', '在线阅读'] },
  { category: 'resource', slug: 'jianguo-fanglye', title: '《建国方略》全文原文：孙文学说、实业计划、民权初步', href: '/resources/jianguo-fanglye', date: '2026-09-19', summary: '孙文 1917–1921 年写成的《建国方略》简体全文：心理建设《孙文学说》、物质建设《实业计划》、社会建设《民权初步》。', tags: ['建国方略', '孙中山', '孙文学说', '实业计划', '民权初步', '知难行易'] },
  { category: 'resource', slug: 'cnt-whitepaper', title: 'CNT内容生态代币经济白皮书（v1.0 正式版）', href: '/onchain-blog/whitepaper', date: '2026-09-21', summary: 'CNT 内容生态代币经济白皮书：总量封顶、双因子衰减挖矿、质量加权贡献分、四层反女巫、销毁分红与 DAO 治理，附智能合约模块清单。', tags: ['CNT', 'Content Token', '白皮书', '内容上链', '代币经济', 'DAO'] },
  { category: 'resource', slug: 'ethereum-whitepaper', title: '以太坊白皮书中文全文｜Ethereum White Paper（Vitalik Buterin, 2014）', href: '/resources/ethereum-whitepaper', date: '2026-09-16', summary: 'Vitalik Buterin 2014 年发表的以太坊白皮书简体中文全文：用图灵完备区块链解释账户、Gas、智能合约和去中心化应用。', tags: ['以太坊白皮书', 'Ethereum', 'Vitalik Buterin', '智能合约', '去中心化应用', 'ETH'] },
  { category: 'resource', slug: 'tapeout-protocol', title: 'TapeOut Protocol｜在 BNB Chain 上设计链上电路', href: '/resources/tapeout-protocol', date: '2026-09-21', summary: '介绍 TapeOut 的 NAND / LATCH 元件、处理器画布与链上“流片”，附中文宣言 PDF。', tags: ['TapeOut', 'BNB Chain', 'NAND', 'LATCH', '链上电路', 'PDF'] },
  { category: 'resource', slug: 'tapeout-xiangqi', title: '链上中国象棋｜TapeOut 主网发布记录', href: '/tapeout-xiangqi', date: '2026-09-23', summary: '已运行在 BNB Chain 的中国象棋，公开 TapeID、容器、版本哈希、发布交易、过程快照与升级记录。', tags: ['TapeOut', '中国象棋', '链上作品', 'BNB Chain', '发布记录'] },
  { category: 'resource', slug: 'niu-lai-movie', title: '《牛来》电影为什么爆火？原片资源、票房逆袭与龙标审批流程', href: '/resources/niu-lai-movie', date: '2026-08-17', summary: '《牛来》原片在线播放与事件资料页：梳理票房逆袭、两人制作团队、龙标审批流程，并核对网络传言。', tags: ['牛来', '动画电影', '电影审查', '龙标', '公共文化'] },
  { category: 'resource', slug: 'liang-wenfeng-investor-meeting', title: '梁文锋投资者交流会：录音文字稿', href: '/resources/liang-wenfeng-investor-meeting', date: '2026-07-23', summary: '一份约 3 小时 44 分钟投资者交流录音的 42 页文字稿，讨论 DeepSeek 的愿景、开源与商业化、AGI 路线、算力和国产芯片。', tags: ['梁文锋', 'DeepSeek', 'AGI', '开源', '算力', '国产芯片', 'PDF'] },
  ...
  { category: 'resource', slug: 'x-article-autopublisher-extension', title: 'X Article 自动发布', href: '/resources/x-article-autopublisher-extension', date: '2026-08-24', summary: '每天定时把 2aran.com 的一篇文章连同排版、链接和正文图片发布为 X Article。', tags: ['X 平台', 'Chrome 插件', 'X Articles', '自动发布', '工具'] },
  ...
  { category: 'resource', slug: 'x-mutual-aid-circle', title: 'X 互帮互助圈子：真实互动，一起把 X 流量玩明白', href: '/x-mutual-aid-circle', tags: ['Twitter', 'X 平台', '社群', '工具', '互动专题'] },
  ...
  ...ENGINEERING_WORKS.flatMap((work) => {
    const pvKey = getRichPagePvKey(work)
    if (!pvKey.startsWith('rich-page/')) return []
    return [{
      category: 'rich-page',
      slug: pvKey.slice('rich-page/'.length),
      title: work.title,
      href: work.href,
      date: work.date,
      summary: work.summary,
      tags: [...(work.tags || []), work.kind, '互动专题'].filter(Boolean),
      audience: work.audience || 'public',
    }]
  }),
  { category: 'feed', slug: 'index', title: '灵感流', href: '/feed', tags: ['灵感', '随笔'] },
  ...getAllFeedItems().map((item) => ({
    category: 'feed',
    slug: item.id,
    title: item.title,
    href: `/feed/${item.id}`,
...
export const CONTENT_PV_CATEGORIES = new Set(['resource', 'feed', 'article', 'rich-page'])

/** key = `${category}/${slug}` */
export const CONTENT_PV_KEY_SET = new Set(CONTENT_PV_ENTRIES.map((e) => `${e.category}/${e.slug}`))
export const STATIC_ARTICLE_PV_KEY_SET = new Set(articles.map((article) => `article/${article.slug}`))
