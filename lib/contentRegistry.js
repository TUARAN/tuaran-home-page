...
export const CONTENT_PV_ENTRIES = [
  ...
  { category: 'resource', slug: 'tapeout-xiangqi', title: 'TapeOut 中国象棋上链计划', href: '/tapeout-xiangqi', date: '2026-09-23', summary: '可试玩的象棋原型，以及计划、实际用时、过程快照和主网授权边界。', tags: ['TapeOut', '中国象棋', '链上游戏', '开发日志'] },
