...
export const TAXONOMY_DIMENSIONS = [
  { id: 'contentKind', label: '内容类型', rule: '单选', description: '内容采用什么表达和使用形态，例如分析、实践、指南或资源。' },
  { id: 'subjects', label: '内容主题', rule: '1–3 个，有顺序', description: '内容主要讨论什么；第一个是主主题，其余是辅助主题。' },
...
export const TAXONOMY_GOVERNANCE_RULES = [
  ...
  '人工填写的 subjects 优先于关键词推断；推断只服务于存量内容迁移。',
  '多主题内容按主次排序；筛选后卡片优先显示用户选中的主题。',
  '主题、对象、交付方式和编辑状态分别管理，避免一个标签承担多种含义。',
  '新增主题前检查边界、样本和持续供给；内容稀疏时优先并入上位主题。',
  '每次调整都抽查正例、反例和多主题内容，并运行分类测试与构建。',
]
