...
export const SUBJECT_GOVERNANCE = {
  workbuddy: {
    definition: '以 WorkBuddy 产品、开放平台、能力接入、使用方法或相关工程实践为主要对象。',
    includes: ['WorkBuddy 使用指南', 'WorkBuddy 开放平台与生态', '围绕 WorkBuddy 的接入与工程实践'],
    excludes: ['仅顺带提及 WorkBuddy 的 Agent 行业分析', '以其他产品为主的横向对比'],
    aliases: ['腾讯 WorkBuddy', 'WorkBuddy 专题'],
  },
  ai_dev: {
  ...
  web_cloud: {
    ...
    excludes: ['模型能力本身', '公链、钱包、加密资产与链上产品', '不含工程细节的产品体验'],
    aliases: ['工程化', '云与架构'],
  },
  web3: {
    definition: '公链、钱包、智能合约、加密资产、链上应用与可验证发布。',
    includes: ['公链与代币机制', '钱包、交易所与 DApp', '加密资产观察与内容上链'],
    excludes: ['普通 Web 与云工程', '不含链上机制的一般投资方法', '只把区块链当比喻的行业分析'],
    aliases: ['加密', '区块链', '链上'],
  },
  product_experience: {
  ...
  business_market: {
    ...
    excludes: ['单一公司的完整档案', '纯产品使用体验', '公链、钱包与加密资产本身'],
    aliases: ['商业', '市场与行业'],
  },
  company_research: {
...
export const TAXONOMY_DIMENSIONS = [
  { id: 'contentKind', label: '内部形态', rule: '单选', description: '保存分析、指南、档案等内部细分；前台类型只显示精选、分析、实践、互动、资源。' },
