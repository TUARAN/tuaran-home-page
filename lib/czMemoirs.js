...
export const CZ_MEMOIR_FIRST_CHAPTER_SLUG = '00-recommendations'
...
export function czMemoirChapterPath(slug) {
  ...
  if (value === CZ_MEMOIR_FIRST_CHAPTER_SLUG) return CZ_MEMOIR_BASE_PATH
  return `${CZ_MEMOIR_BASE_PATH}/${value}`
}
