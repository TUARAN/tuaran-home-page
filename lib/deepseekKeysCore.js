...
export const DEEPSEEK_SITE_MODEL = 'deepseek-v4-flash'

/** 可复用同一条数据库密钥记录的任务来源；环境变量仍按 Cloudflare / GitHub 运行环境彼此隔离。 */
...
/**
 * 绑定匹配优先；没有匹配时可用最近更新的启用记录作数据库兜底。
 * 这只解决共享 D1 内的选键，不会把环境变量同步到另一个 Cloudflare 项目。
 */
