      ...
      .prepare(
        `INSERT INTO deepseek_tasks
          (id, source, task_type, title, execution_status, management_status, priority,
           actor_id, actor_name, model, key_id, key_name, input_summary, result_summary, metadata_json,
         ...
         VALUES
          (?1, ?2, ?3, ?4, 'running', 'pending', 'normal', ?5, ?6, ?7, ?8, ?9, ?10, '', ?11,
           0, 0, 0, 0, '', '', '', ?12, NULL, ?12, ?12)`,
      )
      .bind(
        id,
        text(source, 100),
