...
export const DOWNLOAD_ITEMS = [
  {
    id: 'workbuddy-desktop-pet',
    title: '鹿鹿精灵 · 长颈鹿桌宠',
    href: '/tools/workbuddy-desktop-pet',
    type: 'desktop',
    status: 'building',
    role: 'Electron 桌宠原型 · 网页演示',
    summary: '桌面版支持悬浮、拖动和点击互动；站内可体验本地网页演示，安装包尚未开放。',
    tags: ['Desktop Pet', 'Electron', 'Preview'],
    platforms: ['macOS', 'Windows'],
    actionLabel: '体验网页演示',
    sourcePath: 'tools/workbuddy-desktop-pet',
    priority: 91,
  },
  {
