...
export const ENGINEERING_WORKS = [
  ...
  },
  {
    ...
    category: 'engineering-research',
    subjects: ['humanities_history', 'ai_dev'],
  ...
  },
  {
    ...
    reviewReady: true,
    category: 'engineering-research',
    subjects: ['ai_dev', 'content_creation', 'business_market'],
  ...
  },
  {
    ...
    reviewReady: true,
    category: 'engineering-research',
    subjects: ['web_cloud', 'ai_dev', 'business_market'],
  ...
  },
  {
    ...
    presentation: 'feature',
    category: 'data-visualization',
    subjects: ['life_family', 'business_market'],
  ...
  },
  {
    ...
    subjects: ['content_creation', 'humanities_history'],
