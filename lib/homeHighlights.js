...
const HOME_SECTION_TOTALS = {
  column: articles.length + ENGINEERING_WORKS.length,
  research: listResearch().filter((entry) => !entry.encrypted).length,
  resources: HOME_RESOURCE_ITEMS.length,
  tools: TOOL_ITEMS.length,
}
...
export const HOME_SECTION_MORE_LINKS = [
  {
    label: '创作',
    labelEn: 'Writing',
    href: '/articles?tab=column',
    section: 'column',
    countLabel: `${HOME_SECTION_TOTALS.column} 篇`,
    countLabelEn: `${HOME_SECTION_TOTALS.column}`,
  },
  {
    label: '分析',
    labelEn: 'Analysis',
    ...
    section: 'research',
    countLabel: `${HOME_SECTION_TOTALS.research} 篇`,
    countLabelEn: `${HOME_SECTION_TOTALS.research}`,
  },
  {
    label: '资源',
    labelEn: 'Archive',
    ...
    section: 'resources',
    countLabel: `${HOME_SECTION_TOTALS.resources} 个`,
    countLabelEn: `${HOME_SECTION_TOTALS.resources}`,
  },
  {
    label: '工具',
    labelEn: 'Tools',
    href: '/tools',
    section: 'tools',
    countLabel: `${HOME_SECTION_TOTALS.tools} 个`,
    countLabelEn: `${HOME_SECTION_TOTALS.tools}`,
  },
]

/** 合并创作 / 分析 / 资源推荐，最新条目置顶，其余按日种子随机。 */
