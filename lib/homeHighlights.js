...
function toResourcePick(item) {
  return {
    ...
    section: 'resources',
    sectionLabel: '资料',
    tagLabel: item.tagLabel.replace(/^资料库 · /, ''),
    title: item.title,
    date: item.date,
...
export const HOME_SECTION_MORE_LINKS = [
  { label: '专栏', href: '/articles?tab=posts', section: 'column' },
  { label: '调研', href: '/articles?tab=research', section: 'research' },
  { label: '资料', href: '/articles?tab=resources', section: 'resources' },
]

/** 合并专栏 / 调研 / 资料推荐，最新条目置顶，其余按日种子随机。 */
