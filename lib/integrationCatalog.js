...
export const INTEGRATION_SERVICES = [
  {
    ...
    note: '密钥可加密登记在「调用记录与审计」页，本页只登记台账与兜底环境变量。',
  },
  {
    id: 'github',
    label: 'GitHub',
    provider: 'GitHub REST API',
    purpose: 'A 股草稿发布、本站开发同步、Autopilot 巡检写回。',
    envRefs: ['GITHUB_TOKEN', 'GITHUB_SYNC_TOKEN', 'A_SHARE_PUBLISH_TOKEN'],
  ...
  },
  {
    ...
    label: 'Mac 模型调用同步',
    provider: '本站 D1 台账',
    purpose: '将 Mac → NAS Qwen 的调用摘要、Token、耗时和状态同步到模型调用管理。',
