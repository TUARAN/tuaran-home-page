...
export const HOME_RECOMMENDATION_SOURCES = ['column', 'research', 'resources']

export const DEFAULT_HOME_RECOMMENDATION_SETTINGS = DEFAULT_HOME_RECOMMENDATION_CLIENT_SETTINGS
...
export function normalizeHomeRecommendationSettings(input = {}) {
  ...
  return {
    ...
    sources,
    pinnedIds: [...new Set(Array.isArray(input?.pinnedIds) ? input.pinnedIds : defaults.pinnedIds)]
