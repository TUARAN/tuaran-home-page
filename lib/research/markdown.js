...
function renderDecisionSummary(body, renderer) {
  const inner = renderer.parse(body, { async: false })
  return [
    '<section style="margin:32px 0 8px;padding:22px 22px 18px;border:1px solid #e7b4b4;border-left:6px solid #dc2626;border-radius:14px;background:linear-gradient(145deg,#fff8f7 0%,#fffdf8 58%,#f7f1e7 100%);box-shadow:0 10px 30px rgba(91,45,35,.10)">',
    '<div style="margin-bottom:14px;font-size:11px;font-weight:750;letter-spacing:.16em;color:#b42323;text-transform:uppercase">Relationship Decision</div>',
    inner,
    '</section>',
  ].join('')
}
