...
function renderRiskNote(label, body) {
  return [
    ...
    `<summary><span class="research-risk-note__label">${escapeHtml(label)}</span><span class="research-risk-note__more">展开</span></summary>`,
    `<div class="research-risk-note__body">${body}</div>`,
    '</details>\n',
  ].join('')
}
