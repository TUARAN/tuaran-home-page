...
const CATALOG = [
  {
    resourceKey: 'resource:x-article-autopublisher-extension',
    kind: 'tool',
    delivery: 'download',
    title: 'X Article 自动发布',
    href: '/resources/x-article-autopublisher-extension',
    userDescription: '领取 Chrome 工具包后，可永久下载并查看配置与安装说明。',
    adminDescription: 'Chrome MV3 ZIP；领取时写 download 事件，文件从 MEDIA R2 受控输出。',
    files: {
      'extension-zip': {
        objectKey: 'downloads/x-article-autopublisher-extension-v0.2.6.zip',
        fileName: 'x-article-autopublisher-extension-v0.2.6.zip',
      },
    },
  },
  {
    ...
    files: {
      'macos-universal': {
        objectKey: 'downloads/codex-model-switcher-macos-universal-v1.2.0.zip',
        fileName: 'codex-model-switcher-macos-universal-v1.2.0.zip',
      },
      'skill-zip': {
        objectKey: 'downloads/install-codex-model-switcher-skill-v1.1.0.zip',
        fileName: 'install-codex-model-switcher-skill-v1.1.0.zip',
      },
    },
  },
  {
