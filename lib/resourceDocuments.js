...
export const RESOURCE_DOCUMENTS = {
  ...
  'ethereum-whitepaper': {
    ...
    summary:
      'Vitalik Buterin 2014 年发表的以太坊白皮书简体中文全文：用图灵完备区块链解释账户、Gas、智能合约和去中心化应用。站内带完整目录，并保留 ethereum.org 原文与 2014 年 12 月 PDF。',
  ...
  'jianguo-fanglye': {
    ...
    summary:
      '孙文 1917–1921 年写成的《建国方略》简体全文：心理建设《孙文学说》、物质建设《实业计划》、社会建设《民权初步》。站内带三卷目录；扫描件来自中国国家图书馆数字资源 NLC416-01jh003731-18241。',
