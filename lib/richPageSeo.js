...
const SEO_OVERRIDES = {
  zhuangyuan: {
    metadataTitle: '中国历代状元｜科年、殿试原文、释义与相关资源',
    description: '历代状元资源页：说明解元、会元、状元如何产生，给出唐至清可核对的状元档案，收录文天祥殿试对策与杨慎《临江仙》的原文和释义，并分开处理名次争议与末科传闻。',
    ogTitle: '历代状元：先看科年，再读原文',
    ogDescription: '16 份档案、殿试对策原文与释义、明清人数口径，以及登科录和正史入口。',
    twitterDescription: '状元是殿试第一。科年、原文、释义和不能直接相加的各朝人数。',
    keywords: ['状元', '科举', '殿试', '三元', '文天祥', '商辂', '杨慎', '张謇', '刘春霖', '登科录'],
    schemaType: 'Article',
    image: { url: '/images/zhuangyuan/zhangjian.jpg', width: 945, height: 1192, alt: '光绪二十年状元张謇肖像' },
    about: ['科举', '状元', '殿试对策', '中国古代选官'],
  },
  'ming-emperors': {
    metadataTitle: '明朝十六帝｜276 年皇权时间线、对比表与野史辨析',
    description: '明朝十六帝交互历史图谱：从洪武到崇祯，查看在位时间、继承方式、功业与代价，横向对比四位皇帝，并区分正史事实、后世推测和未证传闻。',
    ogTitle: '一条时间线，看完明朝十六帝',
    ogDescription: '16 位皇帝、17 次登基、276 年国祚：时间线、对比表、帝王档案、配图与野史证据分层。',
    twitterDescription: '从洪武到崇祯：时间线、四帝对比、史实与传闻，一页看完明朝十六帝。',
    keywords: ['明朝十六帝', '明朝皇帝顺序', '明朝历史', '朱元璋', '朱棣', '万历', '崇祯', '明朝时间线', '中国历史'],
    schemaType: 'Article',
    image: { url: '/images/ming-emperors/palace.jpg', width: 1920, height: 2948, alt: '明朝十六帝交互历史图谱题图：《北京宫城图轴》' },
    about: ['明朝', '明朝皇帝', '中国政治史', '明代制度', '历史传闻辨析'],
  },
  quiz: {
    metadataTitle: '2026 年党建知识题库｜学习与考试',
    description: '100 道党建知识单选题与 1 道入党誓词填空题，支持学习模式与计时考试模式。',
    keywords: ['党建知识', '题库', '学习模式', '考试模式'],
    schemaType: 'WebApplication',
    ogType: 'website',
  },
  'adsense-content-check': {
    metadataTitle: 'AdSense 内容质量自检｜低价值内容整改清单',
    description: '将 Google AdSense 最低内容、原创内容、用户体验、内容贫乏和搜索垃圾政策转换为可交互的站点自检表。',
    ogTitle: 'AdSense 低价值内容：逐项检查，别再猜字数',
    ogDescription: '24 项自检、6 类风险、一张待整改清单。结果仅作站内检查，不预测 Google 审核结果。',
    keywords: ['AdSense 低价值内容', 'AdSense 审核', '内容贫乏', '原创内容', '网站质量自检', '用户体验'],
    schemaType: 'WebApplication',
    ogType: 'website',
    about: ['Google AdSense', '内容质量', '网站审核', '用户体验'],
  },
  ...
  'skill-market-research': {
    ...
    ogDescription: '一个 Skill 如何从文件变成互动专题：制作、上架、宣发、回流。',
  },
  ...
  'codex-reset': {
    metadataTitle: 'Codex 重置监控｜Tibo 额度重置与发卡日历',
    description: '按北京时间查看 Tibo 公开的 Codex 额度重置、重置卡发放与原帖。日历来自 AIHOT 公开接口，黄色为预告、绿色为已确认；不读取个人额度，也不猜测下一次重置。',
    ogTitle: 'Codex 什么时候重置？看 Tibo 的公开日历',
    ogDescription: '额度重置、重置卡发放和原帖放在同一张北京时间日历里。个人余额仍以 Codex 内显示为准。',
    keywords: ['Codex 重置', 'Tibo', 'thsottiaux', '重置卡', 'Codex 额度', 'AIHOT', 'OpenAI Codex'],
    schemaType: 'Dataset',
    ogType: 'website',
    about: ['OpenAI Codex', '额度重置', '重置卡', 'Tibo Sottiaux'],
  },
  'whale-wallets': {
    metadataTitle: '公开巨鲸钱包：余额、24 小时变动与中本聪等公众归因',
    description: '查看带公开标签的 Bitcoin / Ethereum 大额地址，并标记公众看法：中本聪创世地址、Mt.Gox 被误传为中本聪、赵长鹏与币安托管、Vitalik、钱志敏扣押等。用 mempool.space 与公共 RPC 读取当前余额。',
    ogTitle: '这些巨鲸地址，公众说是中本聪还是交易所？',
    ogDescription: '每条大额地址附带浏览器标签和公众看法。中本聪的币散落在约 2.2 万个早期出块地址里，富豪榜头部多数是托管和扣押。',
    keywords: ['巨鲸钱包', '中本聪钱包', '比特币富豪榜', '以太坊巨鲸', '链上余额', 'mempool.space', '交易所冷钱包', '政府扣押比特币'],
    schemaType: 'Dataset',
    about: ['Bitcoin', 'Ethereum', '链上巨鲸', '中本聪', '交易所冷钱包', '公开区块链数据'],
  },
  'cancers-overview': {
  ...
  'tang-ping-map': {
    description: '基于 Tang Ping Map 公开点位整理的低总价房源互动专题：按城市、省份、总价、面积、租金、租售比和地理分布筛选观察。',
...
export const RICH_PAGE_SEO = Object.freeze(Object.fromEntries(
  ENGINEERING_WORKS.map((work) => {
    ...
    return [work.id, Object.freeze({
      ...
      robots: override.robots || (work.audience === 'owner'
