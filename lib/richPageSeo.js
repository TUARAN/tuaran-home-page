...
const SEO_OVERRIDES = {
  ...
  'whale-wallets': {
    metadataTitle: '公开巨鲸钱包：当前余额、24 小时变动与免费 API 边界',
    description: '查看带公开标签的 Bitcoin / Ethereum 大额地址：用 mempool.space 与公共 RPC 读取当前余额，用近期交易估算 24 小时变动，并标明完整每日余额历史需要付费索引或自建快照。',
    ogTitle: '公开巨鲸钱包能查到每天的钱吗？',
    ogDescription: '当前余额可以免费读链。24 小时变动能估算。完整每日余额曲线没有稳定的免费批量接口。',
    keywords: ['巨鲸钱包', '比特币富豪榜', '以太坊巨鲸', '链上余额', 'mempool.space', '交易所冷钱包', '政府扣押比特币'],
    schemaType: 'Dataset',
    about: ['Bitcoin', 'Ethereum', '链上巨鲸', '交易所冷钱包', '公开区块链数据'],
  },
  'cancers-overview': {
