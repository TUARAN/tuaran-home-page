    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/classical-masterpieces', label: '古典名篇', labelEn: 'Classics', desc: '单篇作品谱系', descEn: 'Single-work lineage' },
          ...
          { href: '/bookmarks/twitter', label: '推特资讯', labelEn: 'X Notes', desc: 'X/Twitter 前沿动态与观点', descEn: 'X/Twitter signals & notes' },
          { href: '/bookmarks/youtube', label: 'YouTube 收藏', labelEn: 'YouTube', desc: '影像、纪录片与延伸资料', descEn: 'Video archive & references' },
          { href: '/bookmarks/llm-tutorials', label: '大模型教程', labelEn: 'LLM Tutorials', desc: 'LLM 教程与技术文档', descEn: 'LLM guides & docs' },
          { href: '/bookmarks/ai-tools', label: 'AI 工具', labelEn: 'AI Tools', desc: 'AI 工具与产品推荐', descEn: 'AI tools & products' },
          { href: '/bookmarks/dev-resources', label: '开发资源', labelEn: 'Dev Resources', desc: '前端、后端与 DevOps 工具链', descEn: 'Frontend, backend & DevOps' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        titleEn: 'Support',
        items: [
          { href: '/ranbi', label: '获取燃币', labelEn: 'Get Ranbi', desc: '什么是燃币 · 怎么赚怎么用', descEn: 'What Ranbi is & how to earn/spend', tag: 'New' },
