    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/resources/codex-learning-resource-map-yichen', label: 'Codex 学习', labelEn: 'Codex Learning', desc: '逸尘 X 链接帖归档', descEn: 'Curated Codex resource map', tag: 'New' },
          { href: '/resources/shen-zhi-ding-nei', label: '置身 X 内', labelEn: 'Workplace Archive', desc: '大厂职场文本合集', descEn: 'Workplace text archive' },
          ...
          { href: '/resources/wallpapers', label: '壁纸下载', labelEn: 'Wallpapers', desc: '可下载壁纸资源', descEn: 'Downloadable wallpapers', nav: false },
