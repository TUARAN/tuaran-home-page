 ...
 *
 * 一级频道：内容 / 资源 / 工具 / 圈子 / 关于（平台化板块收敛，2026-07）
...
export const SITE_CHANNELS = [
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/articles?tab=column', label: '创作库', labelEn: 'Creation Library', desc: '全部文章与多维页面', descEn: 'All writing & rich pages' },
          { href: '/articles?tab=works', label: '多维页面', labelEn: 'Rich Pages', desc: '交互数据与富页面', descEn: 'Interactive rich pages' },
  ...
  },
  {
    ...
    match: (p, searchParams) =>
      (p?.startsWith('/articles') &&
        (searchParams?.get?.('tab') === 'resources' || Boolean(searchParams?.get?.('resource_type')))) ||
  ...
  },
  {
    ...
    match: (p) =>
      ...
      p?.startsWith('/resources/2aran-desktop') ||
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: 'https://x.com/i/flow/join-birdwatch', label: 'X 违规自查', labelEn: 'X Account Check', desc: '检查近期违规提示', descEn: 'Check recent account warnings', external: true },
          { href: '/desktop-apps', label: '桌面版', labelEn: 'Desktop Apps', desc: 'Windows / macOS 客户端下载', descEn: 'Windows / macOS client downloads', tag: 'New' },
