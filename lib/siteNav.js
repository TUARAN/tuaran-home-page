    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/articles?tab=works', label: '多维页面', labelEn: 'Rich Pages', desc: '可交互数据、长期项目与富页面', descEn: 'Interactive data, long-running projects & rich pages' },
          ...
          { href: '/diary', label: '浮生日记', labelEn: 'Weblog', desc: '阶段性想法、生活片段、年中年终总结与长期记录', descEn: 'Notes, periodic reviews & long-running records' },
        ],
      },
      {
        title: '调研',
