    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?tab=build-logs', label: '建站日志', labelEn: 'Site Building Log', desc: '本站产品选择、改造过程与复盘', descEn: 'Product decisions, changes & retrospectives' },
          { href: '/articles?tab=companies', label: '公司', labelEn: 'Companies', desc: '公司画像与商业分析', descEn: 'Company profiles & analysis' },
          ...
          { href: '/articles?tab=business', label: '商业', labelEn: 'Business', desc: '行业、市场与产品分析', descEn: 'Industry, market & product analysis' },
          { href: '/articles?tab=other', label: '其他', labelEn: 'Other', desc: '观点、写作、职场与生活观察', descEn: 'Opinions, writing, work & life' },
        ],
      },
      {
        title: '资源',
        ...
        items: [
          ...
          { href: '/resources/wallpapers', label: '壁纸收藏', labelEn: 'Wallpaper Collection', desc: '可下载壁纸资源', descEn: 'Downloadable wallpapers', tag: 'New' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/tools#x-platform', label: 'X 平台工具', labelEn: 'X Platform', desc: '内容与账号辅助工具', descEn: 'Content and account utilities' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/skill-center', label: 'Skill 中心', labelEn: 'Skill Center', desc: '模型与智能体能力货架', descEn: 'Model & agent capability shelf', tag: 'Agent' },
          { href: '/mcp-center', label: 'MCP 中心', labelEn: 'MCP Center', desc: '智能体可连接的服务货架', descEn: 'Connectable services for AI agents', tag: 'Agent' },
          { href: '/prompt-center', label: 'Prompt 中心', labelEn: 'Prompt Center', desc: '提示词经验与任务模板', descEn: 'Prompt patterns & task templates', tag: 'Agent' },
