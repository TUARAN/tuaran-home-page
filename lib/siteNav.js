    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/public-opinion', label: '舆情分析', labelEn: 'Public Opinion', desc: '公开内容采集与观点趋势工作台', descEn: 'Public monitoring & opinion trends', tag: 'New' },
          { href: '/stock-analysis', label: '交易分析', labelEn: 'Trade Analysis', desc: '多标的 · 分钟级交易分析快照库', descEn: 'Multi-symbol, minute-level trade analysis snapshots', tag: 'New' },
      ...
      },
      {
        ...
        titleEn: 'Life / Tools',
        items: [
          { href: '/dad-stack', label: 'Dad Stack', labelEn: 'Dad Stack', desc: 'AI × 工程 × 父亲的育儿线', descEn: 'AI × engineering × fatherhood', tag: 'New' },
