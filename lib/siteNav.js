    ...
    sections: [
      {
        title: '专栏',
        items: [
          { href: '/articles?tab=posts', label: '精选文章', desc: '个人判断与原创长文' },
          { href: '/articles/creation-calendar', label: '创作日历', desc: '本站与掘金写作节奏', nav: false },
          { href: '/diary', label: '近期日志', desc: '阶段性想法与生活片段' },
        ],
      },
      {
        title: '调研',
        items: [
          { href: '/articles?tab=companies', label: '公司调研', desc: '公司画像与商业分析' },
          { href: '/articles?tab=topics', label: '事项调研', desc: '技术、行业、市场与写作' },
          { href: '/articles?tab=people', label: '人物调研', desc: '创作者、企业家与学者' },
        ],
      },
      {
        title: '资料',
        items: [
          { href: '/articles?tab=resources', label: '资料库', desc: '原文、谱系与索引' },
          { href: '/classical-masterpieces', label: '古典名篇', desc: '单篇作品谱系', tag: 'New' },
          { href: '/china-politics', label: '政经资料', desc: '当代中国研究' },
          { href: '/reading', label: '书目索引', desc: '阅读计划与笔记' },
          { href: '/bookmarks', label: '资源收藏', desc: '外部材料、教程与工具' },
          { href: '/history/ming-qing', label: '历史笔记', desc: '明清、三国与长篇笔记', nav: false },
    ...
    sections: [
      {
        title: '系统',
        items: [
          { href: '/works', label: '作品索引', desc: '可视化、工具与长期页面', tag: 'New' },
          { href: '/ai-projects', label: 'AI 项目', desc: '公开图谱与私有管理台' },
          { href: '/skill-center', label: 'Skill 中心', desc: '模型与智能体能力货架', tag: 'New' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/platform-framework-pairs', label: 'AI Runtime 三极格局', desc: '11 组配对可视化与研报', tag: 'Hot', nav: false },
    ...
    sections: [
      {
        title: '产品',
        items: [
          { href: 'https://blogger-alliance.cn/', label: '博主联盟', desc: 'AI 产品方与技术博主', external: true, tag: 'Hot' },
          { href: 'https://frontendnext.com/', label: '前端周看', desc: '前端与 AI Agent 情报站', external: true, tag: 'Hot' },
          { href: 'https://publishlab.cc/', label: 'PublishLab', desc: 'AI 写作与数字出版', external: true, tag: 'New' },
        ],
      },
      {
        title: '服务',
        items: [
          { href: '/services', label: '合作说明', desc: '咨询、调研与内容协作' },
          { href: '/project-manager', label: '项目经理视角', desc: '团队、协作与交付', nav: false },
          { href: '/community', label: '社群', desc: '线上线下连接', nav: false },
        ],
      },
      {
        title: '作品',
