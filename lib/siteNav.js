    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/platform-framework-pairs', label: 'CF×VoidZero vs Vercel×Next 研判', desc: 'AI 原生 Web 双巨头割据 · 10 节研报 + 10 组配对可视化', tag: 'Hot', nav: false },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/long-compass', label: '长期罗盘', desc: '加密私域 · 资产 / 复盘 / 行动框架' },
