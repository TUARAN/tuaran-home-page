    ...
    sections: [
      {
        ...
        titleEn: 'Column',
        items: [
          { href: '/feed', label: '灵感', labelEn: 'Inspiration', desc: '短平快的图片 / 视频 / 资源 / 观点', descEn: 'Short-form images, video, resources & takes', tag: 'New' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: 'https://syncblog.cn/', label: '内容同步智能体', labelEn: 'SyncBlog', desc: '一次创作，多平台同步分发', descEn: 'Write once, sync everywhere', external: true, tag: 'New' },
        ],
      },
      {
        title: '服务',
