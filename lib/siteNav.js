    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/articles?tab=works', label: '工程作品', desc: '实测 / 可视化 / 长期项目' },
      ...
      },
      {
        title: '调研',
        items: [
          { href: '/articles?tab=special', label: '专题调研', desc: '富媒体页面包装的结构化调研' },
          { href: '/articles?tab=companies', label: '公司调研', desc: '公司画像 / 商业分析' },
          { href: '/articles?tab=topics', label: '事项调研', desc: '技术 / 行业 / 市场' },
        ],
      },
      {
        title: '资料',
    ...
    sections: [
      {
        title: 'AI 系统',
        items: [
          { href: '/ai-projects', label: 'AI 项目', desc: '数字员工 / Agent / 工具', tag: 'Login' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/xiaomoli-dad-todo', label: '茉莉奶爸待办', desc: '日常 / 习惯 / 家庭节奏', tag: 'Lock' },
          { href: '/voice-tasks', label: '语音记事', desc: '随手说一段，落到文字', tag: 'Lock' },
        ],
      },
      {
        title: '实验室',
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/long-compass', label: '长期罗盘', desc: '加密私域 · 资产 / 复盘 / 行动框架', tag: 'Lock' },
