    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?tab=resources&resource_group=downloads', label: '下载资源', labelEn: 'Download Resources', desc: '可下载壁纸资源', descEn: 'Downloadable wallpapers', tag: 'Hot' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/browser-extensions', label: '浏览器扩展', labelEn: 'Browser Extensions', desc: '可下载的网页工作流小工具', descEn: 'Downloadable browser workflow tools' },
          { href: '/desktop-apps', label: '桌面应用', labelEn: 'Desktop Apps', desc: 'Windows / macOS 客户端下载', descEn: 'Windows / macOS client downloads', tag: 'New' },
          { href: '/voice-tasks', label: '语音记事', labelEn: 'Voice Notes', desc: '登录后用语音记录待办与灵感', descEn: 'Voice notes for signed-in users', audience: 'authed' },
          { href: '/public-opinion', label: '舆情分析', labelEn: 'Public Opinion', desc: '公开内容采集与观点趋势工作台', descEn: 'Public monitoring & opinion trends' },
          { href: '/stock-analysis', label: '交易分析', labelEn: 'Trade Analysis', desc: '多标的 · 分钟级交易分析快照库', descEn: 'Multi-symbol, minute-level trade analysis snapshots' },
        ],
      },
      {
        title: '系统',
