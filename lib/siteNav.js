    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/voice-tasks', label: '语音记事', labelEn: 'Voice Notes', desc: '语音记录待办与灵感', descEn: 'Capture tasks and ideas', audience: 'authed' },
      ...
      },
      {
        ...
        titleEn: 'Build',
        items: [
          { href: '/tools#ai-dev', label: 'AI 开发', labelEn: 'AI & Dev', desc: 'AI 工程与工作流目录', descEn: 'AI engineering workflows' },
          { href: '/tools#indexes', label: '工具索引', labelEn: 'Tool Indexes', desc: '外部工具目录', descEn: 'External tool directories' },
          { href: '/bookmarks/ai-tools', label: 'AI 工具', labelEn: 'AI Tools', desc: '产品与服务推荐', descEn: 'Products and services' },
          { href: '/bookmarks/dev-resources', label: '开发资源', labelEn: 'Dev Resources', desc: '工程工具链索引', descEn: 'Engineering toolchains' },
        ],
      },
      {
        title: '多维页面',
