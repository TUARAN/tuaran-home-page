    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/crypto-research', label: '加密调研', labelEn: 'Crypto Research', desc: '按市值每天一个加密资产', descEn: 'One crypto asset by market cap each day', tag: 'Auto' },
          { href: '/crypto-research/rss', label: 'RSS 订阅', labelEn: 'RSS Feeds', desc: '订阅本站，并阅读已收录源的更新', descEn: 'Subscribe here and read curated feed updates' },
        ],
      },
      {
        title: '内容主题',
        ...
        items: [
          ...
          { href: '/articles?subject=web3', label: 'Web3', labelEn: 'Web3', desc: '公链、钱包、加密资产与链上应用', descEn: 'Chains, wallets, crypto and onchain apps', nav: false },
