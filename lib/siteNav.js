    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/diary', label: '主编札记', labelEn: 'Editor Notes', desc: '阶段性想法、生活片段与主编判断', descEn: 'Editor notes, life fragments & judgment' },
        ],
      },
      {
        title: '调研',
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/community', label: '社群', labelEn: 'Community', desc: '线上线下连接', descEn: 'Online & offline connections' },
