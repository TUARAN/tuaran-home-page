 ...
 *
 * 一级频道：内容 / 工具 / 圈子 / 关于（平台化板块收敛，2026-07；资源归入内容）
    ...
    sections: [
      {
        ...
        titleEn: 'Writing',
        items: [
          { href: '/articles', label: '知识库', labelEn: 'Knowledge Base', desc: '创作、调研与资源总索引', descEn: 'Writing, research & archives' },
          ...
          { href: '/rich-pages', label: '多维页面', labelEn: 'Rich Pages', desc: '交互调研、宣发与内容展示', descEn: 'Interactive research, launch & content pages' },
      ...
      },
      {
        ...
        titleEn: 'Research',
        items: [
          { href: '/articles?tab=research', label: '调研库', labelEn: 'Research Library', desc: '全部公司、事项与人物调研', descEn: 'All company, topic & people research' },
          { href: '/articles?tab=companies', label: '公司调研', labelEn: 'Company Research', desc: '公司画像与商业分析', descEn: 'Company profiles & analysis' },
          { href: '/articles?tab=topics', label: '事项调研', labelEn: 'Topic Research', desc: '技术、行业、市场与写作', descEn: 'Tech, industry, market & writing', tag: 'Hot' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?tab=resources&resource_group=content&resource_type=ai-dev', label: 'AI 与开发', labelEn: 'AI & Dev', desc: '大模型教程、AI 工具与开发资源', descEn: 'LLM tutorials, AI tools & dev resources' },
          { href: '/articles?tab=resources&resource_group=content&resource_type=humanities-politics', label: '人文与政经', labelEn: 'Humanities & Politics', desc: '古典名篇、思想体系与政经资源', descEn: 'Classics, thought systems & politics' },
          { href: '/articles?tab=resources&resource_group=external', label: '收藏资源', labelEn: 'Saved Resources', desc: 'RSS、推特与 YouTube 收藏', descEn: 'RSS, X & YouTube picks' },
          { href: '/articles?tab=resources&resource_group=content&resource_type=workplace', label: '职场资源', labelEn: 'Workplace', desc: '置身 X 内 · 大厂职场文本合集', descEn: 'Workplace text archive' },
          { href: '/resources/wallpapers', label: '壁纸下载', labelEn: 'Wallpapers', desc: '可下载壁纸资源', descEn: 'Downloadable wallpapers', tag: 'Hot' },
          { href: '/articles?tab=resources&resource_group=content&resource_type=ai-music', label: 'AI 音乐', labelEn: 'AI Music', desc: 'AI 音乐作品与可分享卡片', descEn: 'AI music and shareable track cards', tag: 'New' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/browser-extensions', label: '浏览器扩展', labelEn: 'Browser Extensions', desc: '可下载的网页工作流小工具', descEn: 'Downloadable browser workflow tools', tag: 'New' },
          { href: '/desktop-apps', label: '桌面应用', labelEn: 'Desktop Apps', desc: 'Windows / macOS 客户端下载', descEn: 'Windows / macOS client downloads', tag: 'New' },
          { href: '/eatwhat', label: '吃什么', labelEn: 'What to Eat', desc: '今天点什么的小工具', descEn: 'A tiny what-to-order tool', nav: false },
          { href: '/xiaomoli-dad-todo', label: '茉莉奶爸待办', labelEn: 'Dad To-Do', desc: '日常 / 习惯 / 家庭节奏', descEn: 'Daily / habits / family rhythm', audience: 'owner', nav: false },
          { href: '/voice-tasks', label: '语音记事', labelEn: 'Voice Notes', desc: '随手说一段，落到文字', descEn: 'Speak a bit, save as text', audience: 'owner', nav: false },
        ],
      },
      {
        title: '系统',
...
export const SITE_FOOTER_LINKS = [
  ...
  { href: '/about', label: '关于站长', labelEn: 'About the Owner', desc: '站长介绍 / 履历', descEn: 'Owner bio & résumé' },
  { href: '/originals', label: '原创内容', labelEn: 'Originals', desc: '原创文章 / 调研 / 作品', descEn: 'Writing / research / works' },
