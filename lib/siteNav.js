    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/a-share-research', label: 'A股调研', labelEn: 'A-Share Research', desc: '每天一家 A 股上市公司', descEn: 'One listed company at a time', tag: 'New' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?group=interactive', label: '互动', labelEn: 'Interactives', desc: '可阅读、可筛选、可操作的内容作品', descEn: 'Readable, filterable and interactive works' },
