    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/writing-monetization-2026', label: '写作变现 2026', desc: '执行手册', tag: 'New', nav: false },
        ],
      },
      {
        title: '人文思想',
        items: [
          { href: '/poetry', label: '诗词', desc: '原创与摘录', nav: false },
          ...
          { href: '/history/three-kingdoms', label: '三国', desc: '群像 · 人物 · 战役', nav: false },
          { href: '/ru-shi-dao', label: '儒释道', desc: '思想体系笔记', nav: false },
          { href: '/china-politics', label: '当代中国研究', desc: '政经长文', nav: false },
        ],
      },
      {
        title: '资源收藏',
