    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/bookmark-nav', label: '书签导航', labelEn: 'Bookmark Atlas', desc: 'Chrome 私有收藏索引', descEn: 'Private Chrome bookmark index', audience: 'owner' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/rich-pages', label: '互动', labelEn: 'Interactives', desc: '可阅读、可筛选、可操作的内容作品', descEn: 'Readable, filterable and interactive works', tag: '新体验' },
