...
export const SITE_CHANNELS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        titleEn: 'By Topic',
        items: [
          { href: '/articles?subject=workbuddy', label: 'WorkBuddy', labelEn: 'WorkBuddy', desc: '产品、平台、教程与接入实践', descEn: 'Product, platform, guides and integrations', tag: 'New' },
          ...
          { href: '/articles?subject=web3', label: 'Web3', labelEn: 'Web3', desc: '公链、钱包、加密资产与链上应用', descEn: 'Chains, wallets, crypto and onchain apps' },
