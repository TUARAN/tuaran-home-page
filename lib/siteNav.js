    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/works', label: '工程作品', desc: '可视化 / 富页面 / 长期工程' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: '后台管理',
        items: [
          { href: '/agent-ops/project-portfolio', label: 'AI 项目管理台', desc: '项目治理 / 整合路线图', tag: 'Private', audience: 'owner' },
          { href: '/agent-ops/nav-admin', label: '菜单权限管理', desc: '设置每个菜单项对谁可见', tag: 'Admin', audience: 'owner' },
          { href: '/agent-ops/db-admin', label: '数据库管理', desc: 'D1 状态 / 表统计 / 数据量', tag: 'Admin', audience: 'owner' },
          { href: '/agent-ops/share-admin', label: '加密分享管理', desc: 'E2E 加密的家庭文档分享链接', tag: 'Admin', audience: 'owner' },
          { href: 'https://ops.2aran.com/', label: '自动化控制台', desc: '任务编排 / 日志 / Agent Ops', external: true, tag: 'New', audience: 'owner' },
        ],
      },
      {
        title: '工程作品',
        items: [
          { href: '/works', label: '工程作品', desc: '富数据可视化 / 实测 / 长期工程', tag: 'New' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/long-compass', label: '长期罗盘', desc: '加密私域 · 资产 / 复盘 / 行动框架', tag: '端到端加密', audience: 'owner' },
      ...
      },
      {
        title: '站点',
        items: [
          { href: '/changelog', label: '站点更新记录', desc: '按周梳理本站演进', tag: 'New', nav: false },
...
export const SITE_FOOTER_LINKS = [
  ...
  { href: '/services', label: '来合作', desc: '咨询 / 写作 / 推广' },
...
export function flattenChannelRoutesRaw(overrides = null) {
  ...
  return [...fromChannels, ...fromFooter]
}
