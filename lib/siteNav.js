    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/articles/creation-calendar', label: '站内创作日历', desc: '本站写作节奏与产出记录', nav: false },
        ],
      },
      {
        title: '调研',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: '后台管理',
        items: [
          { href: '/agent-ops/project-portfolio', label: 'AI 项目管理台', desc: '项目治理 / 整合路线图', audience: 'owner' },
          { href: '/agent-ops/nav-admin', label: '菜单权限管理', desc: '设置每个菜单项对谁可见', audience: 'owner' },
          { href: '/agent-ops/db-admin', label: '数据库管理', desc: 'D1 状态 / 表统计 / 数据量', audience: 'owner' },
          { href: '/agent-ops/share-admin', label: '加密分享管理', desc: 'E2E 加密的家庭文档分享链接', audience: 'owner' },
          { href: '/agent-ops/ops-console', label: '自动化控制台', desc: '状态检查 / 外部入口 / Agent Ops', audience: 'owner' },
        ],
      },
      {
        title: '工程作品',
