 ...
 * 内容频道按“入口 / 主题 / 类型”组织；分析对象与资源获取方式在统一目录中按需出现。
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?subject=life_family', label: '生活与家庭', labelEn: 'Life & Family', desc: '生活记录、育儿与长期选择', descEn: 'Life, parenting and long-term choices' },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?group=practice', label: '实践', labelEn: 'Practice', desc: '工程案例、指南与互动专题', descEn: 'Cases, guides and interactives' },
