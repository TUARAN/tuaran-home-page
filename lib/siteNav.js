    ...
    sections: [
      {
        ...
        titleEn: 'Systems',
        items: [
          { href: '/works', label: '作品索引', labelEn: 'Work Index', desc: '可视化、工具与长期页面', descEn: 'Visuals, tools & long-running pages', tag: 'New' },
          { href: '/ai-projects', label: 'AI 项目', labelEn: 'AI Projects', desc: '公开图谱与私有管理台', descEn: 'Public map & private console' },
