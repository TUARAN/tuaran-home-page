    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?tab=resources&resource_type=ai-music', label: 'AI 音乐', labelEn: 'AI Music', desc: 'AI 音乐作品与可分享卡片', descEn: 'AI music and shareable track cards', tag: 'New' },
          ...
          { href: '/articles?tab=resources&resource_type=visual-assets', label: '视觉资源', labelEn: 'Visual Assets', desc: '壁纸与可下载视觉素材', descEn: 'Wallpapers and visual downloads' },
