    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/agent-ops/project-portfolio', label: 'AI 项目管理台', desc: '项目治理 / 整合路线图', tag: 'Private', nav: false },
          { href: 'https://ops.2aran.com/', label: '自动化控制台', desc: '任务编排 / 日志 / Agent Ops', external: true, tag: 'New' },
        ],
      },
      {
        title: '工程作品',
    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/long-compass', label: '长期罗盘', desc: '加密私域 · 资产 / 复盘 / 行动框架', tag: '端到端加密' },
