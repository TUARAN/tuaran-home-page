 ...
 * featured: true 表示作为频道总入口，在二级菜单顶部独占一行
    ...
    sections: [
      {
        ...
        titleEn: 'Writing',
        items: [
          { href: '/articles', label: '文章与分析', labelEn: 'Writing & Analysis', desc: '原创文章、专题分析与资源总索引', descEn: 'Writing, analysis & archives', featured: true },
          ...
          { href: '/articles?tab=posts', label: '精选文章', labelEn: 'Featured', desc: '个人判断与原创长文', descEn: 'Original essays & judgment', nav: false },
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/articles?tab=engineering-cases', label: '工程案例', labelEn: 'Engineering Cases', desc: '真实项目的架构、部署与性能实践', descEn: 'Architecture, deployment & performance in real projects' },
          { href: '/articles?tab=build-logs', label: '建站日志', labelEn: 'Site Building Log', desc: '本站产品选择、改造过程与复盘', descEn: 'Product decisions, changes & retrospectives', nav: false },
          { href: '/articles?tab=companies', label: '公司', labelEn: 'Companies', desc: '公司画像与商业分析', descEn: 'Company profiles & analysis', nav: false },
          { href: '/articles?tab=people', label: '人物', labelEn: 'People', desc: '创作者、企业家与学者', descEn: 'Creators, founders & scholars', nav: false },
          { href: '/articles?tab=tech', label: '技术', labelEn: 'Technology', desc: '技术架构、工具与工程实践', descEn: 'Architecture, tools & engineering', tag: 'Hot' },
          { href: '/articles?tab=business', label: '商业', labelEn: 'Business', desc: '行业、市场与产品分析', descEn: 'Industry, market & product analysis', nav: false },
          { href: '/articles?tab=other', label: '其他', labelEn: 'Other', desc: '观点、写作、职场与生活观察', descEn: 'Opinions, writing, work & life', nav: false },
        ],
      },
      {
        title: '资源',
        titleEn: 'Archive',
        items: [
          // 资源总入口与高辨识度项目进入主导航，细分类继续留在资源页和 /map。
          { href: '/articles?tab=resources', label: '资源库', labelEn: 'Library', desc: '全部内容、收藏与下载资源', descEn: 'All content, saved picks & downloads' },
          { href: '/articles?tab=resources&resource_group=content', label: '内容资源', labelEn: 'Content Resources', desc: 'AI 与开发、人文政经、职场与 AI 音乐', descEn: 'AI, humanities, workplace & music', nav: false },
          { href: '/articles?tab=resources&resource_group=external', label: '国外资源', labelEn: 'Global Resources', desc: 'RSS、推特与 YouTube 收藏', descEn: 'RSS, X & YouTube picks', nav: false },
          { href: '/resources/rss', label: 'RSS 订阅', labelEn: 'RSS Feeds', desc: '订阅墙、推荐源与站内 mini 阅读器', descEn: 'Feed directory, recommendations & mini reader' },
          { href: '/resources/wallpapers', label: '壁纸收藏', labelEn: 'Wallpaper Collection', desc: '可下载壁纸资源', descEn: 'Downloadable wallpapers', tag: 'New', nav: false },
