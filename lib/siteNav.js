    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/articles/year-summary', label: '年中年终总结', labelEn: 'Mid-Year & Year-End', desc: '阶段总结时间线目录', descEn: 'Timeline of periodic reviews' },
          ...
          { href: '/diary', label: '浮生日记', labelEn: 'Weblog', desc: '阶段性想法、生活片段与长期记录', descEn: 'Notes, life fragments & long-running records' },
        ],
      },
      {
        title: '调研',
