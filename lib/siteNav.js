...
import { COMMUNITY_TOPICS } from './communityTopics'
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/resources/wisdom-frontier', label: '智慧边界', labelEn: 'Wisdom Frontier', desc: '全球顶级奖项、人物与人类成就图谱', descEn: 'Top prizes, people & human achievements', tag: 'New' },
