 ...
 * 内容频道按“入口 / 用途 / 主题”组织；内容形态、研究对象与使用方式在统一目录中筛选。
    ...
    sections: [
      {
        ...
        titleEn: 'Start',
        items: [
          { href: '/#start-here', label: '从这里开始', labelEn: 'Start Here', desc: '按目标选择第一条路径', descEn: 'Choose a first path by goal', featured: true },
          { href: '/articles', label: '全部内容', labelEn: 'All Content', desc: '统一浏览、搜索和筛选', descEn: 'Browse, search and filter' },
          { href: '/frontend-weekly', label: '前端周看', labelEn: 'Frontend Weekly', desc: '前端、AI Agent 与工程情报', descEn: 'Frontend, AI Agent & engineering intel', tag: 'New' },
          { href: '/feed', label: '最新灵感', labelEn: 'Latest Notes', desc: '短记录与即时观察', descEn: 'Short notes and current observations' },
        ],
      },
      {
        title: '按用途',
        titleEn: 'By Goal',
        items: [
          { href: '/articles?kind=guide', label: '学习与入门', labelEn: 'Learn & Start', desc: '指南、路线和基础资料', descEn: 'Guides, paths and foundations' },
          { href: '/articles?group=analysis', label: '深度理解', labelEn: 'Understand', desc: '分析、核验与对象档案', descEn: 'Analysis, verification and profiles' },
          { href: '/articles?group=practice', label: '工程实践', labelEn: 'Build', desc: '案例、实作与互动专题', descEn: 'Cases, hands-on work and interactives' },
          { href: '/articles?group=resource', label: '获取资料', labelEn: 'Resources', desc: '档案、下载、订阅与收藏', descEn: 'Archives, downloads and subscriptions' },
          { href: '/articles?delivery=subscribe', label: '订阅动态', labelEn: 'Subscribe', desc: '周刊、RSS 与持续更新系列', descEn: 'Newsletters, RSS and recurring series' },
          { href: '/articles?entity=company', label: '了解公司', labelEn: 'Companies', desc: '公司画像与商业分析', descEn: 'Company profiles and business analysis' },
          { href: '/articles?entity=person', label: '了解人物', labelEn: 'People', desc: '创作者、企业家与学者', descEn: 'Creators, founders and scholars' },
        ],
      },
      {
        title: '按主题',
        ...
        items: [
          ...
          { href: '/articles?subject=product_business', label: '产品与商业', labelEn: 'Product & Business', desc: '公司、行业、市场与产品', descEn: 'Companies, industries, markets and products' },
          { href: '/articles?subject=content_creation', label: '内容创作', labelEn: 'Content Creation', desc: '写作、传播、视觉与创作者', descEn: 'Writing, distribution, visuals and creators' },
          { href: '/articles?subject=workplace_org', label: '职场与组织', labelEn: 'Work & Organizations', desc: '团队、社区与职业观察', descEn: 'Teams, communities and work' },
          { href: '/articles?subject=humanities_history', label: '人文与历史', labelEn: 'Humanities & History', desc: '人物、制度、思想与历史资料', descEn: 'People, institutions, ideas and history' },
