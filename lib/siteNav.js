    ...
    sections: [
      {
        ...
        items: [
          ...
          { href: '/capabilities', label: '能力集', labelEn: 'Capabilities', desc: 'Skill、MCP、Prompt 与 WorkBuddy 能力包', descEn: 'Skills, MCP services, prompts and WorkBuddy packages' },
