export const SITE_PUBLIC_COMPONENT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { name: 'ShowcaseDirectory', role: '统一目录的搜索、筛选、卡片与列表视图。gallery 用于产品集和互动专题；catalog 用于工具集与 Agent 能力集，图标更小、封面更短、网格更密。', scope: '目录页面' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'ReadAloudButton', role: '朗读当前正文，放在分享按钮旁边。', scope: '文章与调研' },
