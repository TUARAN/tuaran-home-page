...
const INDEXABLE_PATHS = [
  ...
  '/resources/tapeout-protocol',
  '/resources/wallpapers',
  '/resources/workbuddy-opc-whitepaper',
  '/resources/workbuddy-smart-hardware-whitepaper',
  ...
  '/tools/workbuddy-desktop-pet/hardware-roadmap',
  '/web3',
  '/web3/us-stocks',
