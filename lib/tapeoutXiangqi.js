...
export const TAPEOUT_XIANGQI_PLAN = Object.freeze([
  ...
  },
  {
    ...
    owner: 'codex',
    status: 'done',
    planned: '2026-09-23 14:03–14:25 CST',
    actual: '2026-09-23 14:04–14:12 CST',
    output: '加入浏览器本地 Minimax + Alpha-Beta 棋力，默认玩家执红、机器执黑；保留双人模式，人机悔棋回退完整回合。真实浏览器走子验收通过。',
  },
  {
    id: 'ai-mainnet-update',
    title: '原容器覆盖更新 AI 版本',
    owner: 'shared',
    status: 'done',
    planned: '5–10 分钟·预计 1 笔钱包确认',
    actual: '2026-09-23 14:54–14:58 CST·1 笔钱包确认',
    output: '持有人确认原容器 SiteRegistry.putFile；Codex 从链上核对 11,512 bytes、单分块与 SHA-256。原 TapeID、容器和网址保持不变。',
  },
])
...
export const TAPEOUT_XIANGQI_RELEASE = Object.freeze({
  ...
  fileSize: 11512,
  sha256: 'a35a435bf3cef71d6be686d1a09db087b7a2f16242f847f19556d3dfc939fc6d',
  latestUpgrade: Object.freeze({
    version: 'AI 对弈升级',
    status: 'live',
    fileSize: 11512,
    sha256: 'a35a435bf3cef71d6be686d1a09db087b7a2f16242f847f19556d3dfc939fc6d',
    method: 'SiteRegistry.putFile',
    transactions: 1,
    transactionHash: '0x49f8086cc78a05493336afee9ac9d26661b2bae1c1ca6d2a82d99d732f456ee3',
    updatedAt: '2026-09-23 14:54:09 CST',
    gasUsed: 2643430,
    gasPriceWei: 59941795,
    gasCost: '0.00015845193915685 BNB',
  }),
  updatePolicy: Object.freeze({
    protocolFee: '0 BNB（同一路径覆盖没有额外协议费）',
    payment: '每次修改只支付 BSC Gas，实际金额随文件体积、分块数和当时 Gas Price 变化',
    singleTransactionLimit: '文件不超过 24,000 bytes：通常 1 笔 putFile',
    chunkedUpdate: '超过 24,000 bytes：1 笔 putFile + 每个后续分块 1 笔 appendChunk',
    unchanged: '同一容器更新无需重新 Mint、Tapeout、Open 或 Bind；名字到期续费另计',
  }),
  costSummary: Object.freeze({
    protocol: '0.01233 BNB',
    gas: '约 0.000351086939 BNB',
    total: '约 0.012681086939 BNB',
    note: '已含 AI 升级 Gas 0.00015845193915685 BNB；早期三笔 Gas 按页面显示精度汇总。',
  }),
  transactions: Object.freeze([
    ...
    { label: 'AI upgrade putFile', hash: '0x49f8086cc78a05493336afee9ac9d26661b2bae1c1ca6d2a82d99d732f456ee3', value: '0 BNB + 0.00015845193915685 BNB gas' },
  ]),
})
...
export const TAPEOUT_XIANGQI_SNAPSHOTS = Object.freeze([
  ...
  {
    time: '2026-09-23 14:04–14:11 CST',
    title: '快照 10 · 本地 AI 对弈完成',
    detail: '加入 Minimax + Alpha-Beta 本地棋力，默认玩家执红、机器执黑；保留双人模式。AI 不调用服务器或第三方模型。',
  },
  {
    time: '2026-09-23 14:12 CST',
    title: '快照 11 · AI 升级包待签名',
    detail: '浏览器验证自动应棋与整回合悔棋通过。新包 11,512 bytes，SHA-256 a35a435b…c939fc6d，低于 24 KB，可用 1 笔 putFile 原地升级。',
  },
  {
    time: '2026-09-23 14:54–14:58 CST',
    title: '快照 12 · AI 版本原地升级完成',
    detail: '持有人确认 1 笔 putFile。交易 0x49f8086c…2f456ee3，金额 0 BNB，Gas 2,643,430，实际 Gas 成本 0.00015845193915685 BNB；链上 fileInfo 已匹配 11,512 bytes 与新 SHA-256。',
  },
])
