...
export const WORK_TYPE_META = [
  {
    ...
    titleEn: 'Products',
    label: 'Product',
    description: '对外运营的长期项目、品牌入口和商业化载体。',
  },
  {
    id: 'ai-engineering',
    title: 'AI 工程',
...
export const PRODUCT_WORK_ITEMS = [
  {
    ...
    status: 'operating',
    role: '个人门户 / 内容系统 / 项目总览',
    summary: '个人网络日志、调研知识库、作品入口和长期创作内容沉淀。',
  ...
  },
  {
    ...
    status: 'building',
    role: '创作工具 / 数字出版实验室',
    summary: '面向创作者的 AI 写作与出版工具，把选题、写作、编辑和发布流程沉淀成系统。',
    tags: ['AI Writing', 'Publishing', 'Workflow'],
...
export const FEATURED_WORK_ITEM_IDS = ['blogger-alliance', 'frontend-next', 'publishlab']
