...
summary: 中国移动整合九大基地组建的互联网专业子公司，2015 年广州落地、注册资本 30 亿、千人级团队。表面是"5G 消息国家队"，本质是央企互联网化叙事的"标本与遗骸"。
source: claude-code
...
- **公司全称**：中移互联网有限公司（**注意**：与"中国移动互联网有限公司"是两个不同的子公司，名字极易混淆）
- **品牌简称**：CMIC（cmic.chinamobile.com）
- **成立时间**：**2015-10-30**
...
- **如果你是开发者/普通用户** → 中移互联网的产品几乎对你的日常没影响；除非你是企业 IT 决策者，否则可以忽略
- **如果你是技术博主/创作者** → 5G 消息 + RCS + Chatbot 是值得跟踪的"to B 内容选题"，但不要对其爆发抱预期
- **如果你是企业市场 / 通知运营人员** → 5G 消息**值得纳入通道组合**作为传统短信的补充，但不要 all-in
- **如果你做投资判断** → 中移互联网本身不可投；但其生态合作伙伴（梦网科技、菊风、东软）值得跟踪
