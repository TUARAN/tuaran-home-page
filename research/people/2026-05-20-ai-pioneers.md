...
summary: 深度学习是几代研究者在寒冬、数据、算力、算法和产业化之间长期接力的结果。
tldr: 这组人物最值得研究的地方，是他们分别代表了 AI 崛起的不同关键变量：辛顿和本吉奥守住神经网络路线，杨立昆把卷积网络做成可用系统，李飞飞用 ImageNet 证明数据规模的力量，克里泽夫斯基用 AlexNet 引爆 GPU + CNN 时代，苏茨克维把深度学习推向大模型与产品化浪潮。他们是一条技术路线从边缘到主流的六个支点。
assistance: codex
model: gpt-5
pv: 0
---
...
在神经网络不被看好的年代，他持续推动反向传播、表征学习、深度信念网络等路线。2012 年 AlexNet 的胜利，让很多人回头发现：原来这条路是有人在冷门时期一直往前推。
...
- 主要资料来自站内旧版 AI 先驱时间线、公开学术史和 ImageNet / AlexNet / Transformer / ChatGPT 等关键节点资料；本文是人物群像与路线分析，不替代严肃学术史。资料截至 2026-05-20。
