...
1. [项目概览](#一项目概览)
2. [起源与动机](#二起源与动机——为什么要写一个-deepseek-专属框架)
3. [核心架构设计](#三核心架构设计)
4. [三大技术支柱（Pillars）](#四三大技术支柱pillars)
   - [Pillar 1：Cache-First Loop](#pillar-1cache-first-loop缓存优先循环)
   - [Pillar 2：R1 Thought Harvesting](#pillar-2r1-thought-harvesting推理链收割)
   - [Pillar 3：Tool-Call Repair](#pillar-3tool-call-repair工具调用修复层)
5. [工具系统与 MCP 插件协议](#五工具系统与-mcp-插件协议)
6. [双模型协作](#六双模型协作two-model-collaboration)
7. [Checkpoints 与 Rewind 机制](#七checkpoints-与-rewind-机制)
8. [权限与沙盒系统](#八权限与沙盒系统)
9. [记忆与会话管理](#九记忆与会话管理)
10. [Go 重写决策分析](#十从-typescript-到-go重写的工程决策)
11. [竞品横向对比](#十一竞品横向对比)
12. [实测性能数据](#十二实测性能数据)
13. [选型建议与局限性](#十三选型建议与局限性)
14. [路线图与社区生态](#十四路线图与社区生态)
15. [总结](#十五总结)
