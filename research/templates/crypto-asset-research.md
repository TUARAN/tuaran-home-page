...
写作口径：先把已经能确认的机制、用途和风险写清楚。关键数字和一手来源要严谨，缺项不抢戏。真正决定观察的一两个变量写透，其余收短。
...
一句话说明它解决什么问题、凭什么获得当前市值、最关键的持续观察变量。再列 3–5 个已经能核验的要点，不要用缺项开场。

## 二、起源、背景与发展时间线

交代创始团队或发起组织、白皮书或主网上线时间、历史阶段、关键升级、重大危机与恢复过程。匿名创始人或争议归属如果会改变判断，在文末记一条即可，不要做成这一节的主体。
...
继续核对发行、增发或销毁规则、初始分配、团队与投资人份额、解锁计划、集中度和质押比例。缺少可靠数据、且会改变对供给结构的判断时，留到「十、信息来源与持续验证」末尾。
...
把已确认的升级、解锁、治理提案等事项与观察者判断分开。真正可能改写判断的风险写清触发条件；技术、供给、治理、监管、流动性和竞争里，只展开已经能看清的那几条。

## 十、信息来源与持续验证

先写来源。来源优先级：项目官方文档与代码仓库；链上浏览器和治理记录；监管/法院文件；CoinGecko 市场快照；可靠研究机构与媒体。列出直接链接和资料截至时间。会改变判断的冲突口径或未公开信息，放在节末「持续验证」短列表；不影响判断的缺口可以不写。
