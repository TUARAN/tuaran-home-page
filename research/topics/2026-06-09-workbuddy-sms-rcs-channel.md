...
summary: 把 AI 工作助手（WorkBuddy）和"短信 / 5G 消息"这条 channel 接上，理论上能拿到 99% 触达率和锁屏强提醒的杀手锏，但 2026 年的国内监管把这条路对个人开发者基本封死——签名实名制、模板审核、新版《电信短信息服务管理规定》5 月 1 日生效。把连接器（MCP vs 云厂商 SDK）、技能（发自己 / 发他人 / 群发）、思路（必要性 / 辅助定位）三个维度逐条拆开，论证「个人 workbuddy + SMS」99% 走不通，但「企业 workbuddy + 5G 消息 chatbot」这条路在 2026 仍然有空间。
...
这三条决定了 SMS / 5G 消息**至少有「IM 失败时的备份通道」的位置**。对**个人 WorkBuddy** 来说，还要跨过四道墙。
