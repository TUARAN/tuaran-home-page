...
这两年聊 AI 都在聊模型和算力，但更容易被忽略的问题是：这些芯片和光模块到底在哪儿造，为什么只能在那里造？
...
- 台积电先进制程、韩系存储、珠三角光模块等市占率采用行业反复引用的量级；不同机构与年份会相差几个百分点，正文只作大致比较，不当作精确事实。产业链解释属于外部观察，不替任何一方作命运判断。资料截至 2026-06-29。
