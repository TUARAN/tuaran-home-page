...
test('万物上链 page exposes the whitepaper entry without issuance commentary', () => {
  ...
  assert.match(blog, /一个人说 123/)
  assert.match(blog, /123\+4/)
  assert.match(blog, /href="#whitepaper"/)
  assert.match(blog, /CONTENT_LINEAGE/)
  assert.match(blog, /a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3/)
  assert.match(blog, /18ec36d229e478529640195045f6cf42ba55e3162f3518bcff2992e78a2a96af/)
  assert.match(blog, /下载 v1\.0 完整版/)
  assert.match(blog, /TOKEN_ALLOCATION/)
