...
测试功能：你打开 Followers / Verified Followers 页面后，展开面板里的「测试功能」，点击「一键回关粉丝」，扩展会慢速批量点击显示 `Follow back` / `回关` 的账号。这个功能只用于回关已经关注你的账号，不会点击普通 `Follow`。
